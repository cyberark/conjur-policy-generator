...
Opal.modules["router"] = function(Opal) {
  ...
  Opal.add_stubs(['$include', '$lambda', '$go_to', '$route', '$go_home']);
  return (function($base, $super, $parent_nesting) {
    function $Router(){};
    var self = $Router = $klass($base, $super, 'Router', $Router);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Router_go_home_2, TMP_Router_routes_3;

    
    self.$include(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Inesita'), 'Router'));
    
    Opal.defn(self, '$go_home', TMP_Router_go_home_2 = function $$go_home() {
      var TMP_1, self = this;
    ...
    }, TMP_Router_go_home_2.$$arity = 0);
    return (Opal.defn(self, '$routes', TMP_Router_routes_3 = function $$routes() {
      var self = this;
      ...
      return self.$route("/", $hash2(["to", "on_enter"], {"to": Opal.const_get_relative($nesting, 'Home'), "on_enter": self.$go_home()}));
    }, TMP_Router_routes_3.$$arity = 0), nil) && 'routes';
  })($nesting[0], null, $nesting)
};
/* Generated by Opal 0.11.1 */
Opal.modules["store"] = function(Opal) {
  ...
  Opal.add_stubs(['$include', '$change_generator', '$include?', '$supported_generators', '$raise', '$clone', '$dig', '$!', '$[]=', '$-', '$[]', '$+', '$value', '$toMAML', '$new', '$current_generator', '$values']);
  return (function($base, $super, $parent_nesting) {
    function $Store(){};
    var self = $Store = $klass($base, $super, 'Store', $Store);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Store_init_1, TMP_Store_supported_generators_2, TMP_Store_change_generator_3, TMP_Store_current_generator_4, TMP_Store_value_5, TMP_Store_increase_6, TMP_Store_decrease_7, TMP_Store_policy_text_8;
    ...
    Opal.defn(self, '$init', TMP_Store_init_1 = function $$init() {
      ...
      return self.$change_generator("secrets")
    ...
    Opal.defn(self, '$supported_generators', TMP_Store_supported_generators_2 = function $$supported_generators() {
      ...
      return $hash2(["humans", "secrets"], {"humans": $hash2(["generator", "defaults"], {"generator": Opal.const_get_qualified(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Conjur'), 'PolicyGenerator'), 'Humans'), "defaults": $hash2(["users", "groups", "users_per_group"], {"users": 2, "groups": 1, "users_per_group": 1})}), "secrets": $hash2(["generator", "defaults"], {"generator": Opal.const_get_qualified(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Conjur'), 'PolicyGenerator'), 'Secrets'), "defaults": $hash2(["secrets", "annotations_per_secret"], {"secrets": 1, "annotations_per_secret": 1})})})
    ...
    Opal.defn(self, '$current_generator', TMP_Store_current_generator_4 = function $$current_generator() {
      var self = this;

      return self.$supported_generators().$dig(self.current_generator, "generator")
    }, TMP_Store_current_generator_4.$$arity = 0);
    ...
    return (Opal.defn(self, '$policy_text', TMP_Store_policy_text_8 = function $$policy_text() {
      var self = this;

      return $send(self.$current_generator(), 'new', Opal.to_a(self.variables.$values())).$toMAML()
    }, TMP_Store_policy_text_8.$$arity = 0), nil) && 'policy_text';
  })($nesting[0], null, $nesting)
};
/* Generated by Opal 0.11.1 */
...
Opal.modules["components/home"] = function(Opal) {
  ...
  Opal.add_stubs(['$include', '$bg_light', '$div', '$component']);
  return (function($base, $super, $parent_nesting) {
    function $Home(){};
    ...
    return (Opal.defn(self, '$render', TMP_Home_render_2 = function $$render() {
      ...
      return $send(self.$div(), 'bg_light', [$hash2(["style"], {"style": $hash2(["margin-bottom"], {"margin-bottom": "10rem"})})], (TMP_1 = function(){var self = TMP_1.$$s || this;

      return self.$component(Opal.const_get_relative($nesting, 'Policy'))}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1))
...
Opal.modules["components/navbar"] = function(Opal) {
  ...
  Opal.add_stubs(['$include', '$bg_light', '$navbar_light', '$navbar_expand_lg', '$navbar', '$nav', '$navbar_brand', '$span', '$text', '$navbar_collapse', '$collapse', '$div', '$mr_auto', '$navbar_nav', '$ul', '$nav_item', '$li', '$class_names', '$current_url?', '$router', '$nav_link', '$a', '$url_for']);
  return (function($base, $super, $parent_nesting) {
    function $NavBar(){};
    var self = $NavBar = $klass($base, $super, 'NavBar', $NavBar);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_NavBar_render_9;

    
    self.$include(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Inesita'), 'Component'));
    return (Opal.defn(self, '$render', TMP_NavBar_render_9 = function $$render() {
      var TMP_1, self = this;

      return $send(self.$nav().$navbar().$navbar_expand_lg().$navbar_light(), 'bg_light', [], (TMP_1 = function(){var self = TMP_1.$$s || this, TMP_2, TMP_3;

      
        $send(self.$span(), 'navbar_brand', [], (TMP_2 = function(){var self = TMP_2.$$s || this;

        return self.$text("Conjur Policy Generator")}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2));
        return $send(self.$div().$collapse(), 'navbar_collapse', [], (TMP_3 = function(){var self = TMP_3.$$s || this, TMP_4;

        return $send(self.$ul().$nav().$navbar_nav(), 'mr_auto', [], (TMP_4 = function(){var self = TMP_4.$$s || this, TMP_5, TMP_7;

          
            $send(self.$li(), 'nav_item', [$hash2(["class"], {"class": self.$class_names($hash2(["active"], {"active": self.$router()['$current_url?']("home")}))})], (TMP_5 = function(){var self = TMP_5.$$s || this, TMP_6;

            return $send(self.$a(), 'nav_link', [$hash2(["href"], {"href": self.$router().$url_for("home")})], (TMP_6 = function(){var self = TMP_6.$$s || this;

              return self.$text("Home")}, TMP_6.$$s = self, TMP_6.$$arity = 0, TMP_6))}, TMP_5.$$s = self, TMP_5.$$arity = 0, TMP_5));
            return $send(self.$li(), 'nav_item', [$hash2(["class"], {"class": self.$class_names($hash2(["active"], {"active": self.$router()['$current_url?']("about")}))})], (TMP_7 = function(){var self = TMP_7.$$s || this, TMP_8;

            return $send(self.$a(), 'nav_link', [$hash2(["href"], {"href": self.$router().$url_for("about")})], (TMP_8 = function(){var self = TMP_8.$$s || this;

              return self.$text("About")}, TMP_8.$$s = self, TMP_8.$$arity = 0, TMP_8))}, TMP_7.$$s = self, TMP_7.$$arity = 0, TMP_7));}, TMP_4.$$s = self, TMP_4.$$arity = 0, TMP_4))}, TMP_3.$$s = self, TMP_3.$$arity = 0, TMP_3));}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1))
    }, TMP_NavBar_render_9.$$arity = 0), nil) && 'render';
  })($nesting[0], null, $nesting)
};
/* Generated by Opal 0.11.1 */
Opal.modules["components/policy"] = function(Opal) {
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $send = Opal.send, $hash2 = Opal.hash2, $truthy = Opal.truthy;

  Opal.add_stubs(['$include', '$lambda', '$increase', '$store', '$render!', '$decrease', '$col_sm', '$mb_3', '$input_group', '$numeric_control', '$div', '$input_group_prepend', '$input_group_text', '$label', '$text', '$btn_outline_secondary', '$btn', '$button', '$dec', '$text_center', '$form_control', '$input', '$value', '$input_group_append', '$inc', '$policy_text', '$a', '$input_group_btn', '$span', '$btn_default', '$[]', '$props', '$h4', '$render_download_button', '$container', '$footer', '$render_numeric_control']);
  return (function($base, $super, $parent_nesting) {
    function $Policy(){};
    var self = $Policy = $klass($base, $super, 'Policy', $Policy);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Policy_inc_2, TMP_Policy_dec_4, TMP_Policy_render_numeric_control_11, TMP_Policy_render_download_button_15, TMP_Policy_render_19;
    ...
    Opal.defn(self, '$render_numeric_control', TMP_Policy_render_numeric_control_11 = function $$render_numeric_control(variable, description) {
      var TMP_5, self = this;

      return $send(self.$div().$numeric_control().$input_group().$mb_3(), 'col_sm', [], (TMP_5 = function(){var self = TMP_5.$$s || this, TMP_6, TMP_9;

      
        $send(self.$div(), 'input_group_prepend', [], (TMP_6 = function(){var self = TMP_6.$$s || this, TMP_7, TMP_8;

        
          $send(self.$label(), 'input_group_text', [], (TMP_7 = function(){var self = TMP_7.$$s || this;

          return self.$text(description)}, TMP_7.$$s = self, TMP_7.$$arity = 0, TMP_7));
          return $send(self.$button().$btn(), 'btn_outline_secondary', [$hash2(["style", "onclick"], {"style": $hash2(["background"], {"background": "white"}), "onclick": self.$dec(variable)})], (TMP_8 = function(){var self = TMP_8.$$s || this;

          return self.$text("-")}, TMP_8.$$s = self, TMP_8.$$arity = 0, TMP_8));}, TMP_6.$$s = self, TMP_6.$$arity = 0, TMP_6));
        ...
        return $send(self.$div(), 'input_group_append', [], (TMP_9 = function(){var self = TMP_9.$$s || this, TMP_10;

        return $send(self.$button().$btn(), 'btn_outline_secondary', [$hash2(["style", "onclick"], {"style": $hash2(["background"], {"background": "white"}), "onclick": self.$inc(variable)})], (TMP_10 = function(){var self = TMP_10.$$s || this;

          return self.$text("+")}, TMP_10.$$s = self, TMP_10.$$arity = 0, TMP_10))}, TMP_9.$$s = self, TMP_9.$$arity = 0, TMP_9));}, TMP_5.$$s = self, TMP_5.$$arity = 0, TMP_5))
    }, TMP_Policy_render_numeric_control_11.$$arity = 2);
    
    Opal.defn(self, '$render_download_button', TMP_Policy_render_download_button_15 = function $$render_download_button() {
      var TMP_12, self = this, data_encoded = nil, uri = nil;

      
      data_encoded = btoa(self.$store().$policy_text());
      uri = "" + "data:application/yaml;base64," + (data_encoded);
      return $send(self.$div(), 'input_group', [$hash2(["style"], {"style": $hash2(["padding", "margin-top", "background"], {"padding": "1rem", "margin-top": "-0.5rem", "background": "white"})})], (TMP_12 = function(){var self = TMP_12.$$s || this, TMP_13;

      return $send(self, 'a', [$hash2(["href", "target", "download", "style"], {"href": uri, "target": "_blank", "download": "policy.yml", "style": $hash2(["border", "border-radius"], {"border": "1px solid #d4d4d4", "border-radius": "5px"})})], (TMP_13 = function(){var self = TMP_13.$$s || this, TMP_14;

        return $send(self.$span(), 'input_group_btn', [], (TMP_14 = function(){var self = TMP_14.$$s || this;

          return self.$button().$btn().$btn_default("Download Policy YAML")}, TMP_14.$$s = self, TMP_14.$$arity = 0, TMP_14))}, TMP_13.$$s = self, TMP_13.$$arity = 0, TMP_13))}, TMP_12.$$s = self, TMP_12.$$arity = 0, TMP_12));
    }, TMP_Policy_render_download_button_15.$$arity = 0);
    return (Opal.defn(self, '$render', TMP_Policy_render_19 = function $$render() {
      var TMP_16, TMP_17, TMP_18, self = this;

      
      if ($truthy(self.$props()['$[]']("header"))) {
        $send(self, 'h4', [], (TMP_16 = function(){var self = TMP_16.$$s || this;

        return self.$text(self.$props()['$[]']("header"))}, TMP_16.$$s = self, TMP_16.$$arity = 0, TMP_16))};
      $send(self, 'div', [$hash2(["style"], {"style": $hash2(["font-family", "white-space", "padding", "padding-bottom", "border-bottom", "margin"], {"font-family": "monospace", "white-space": "pre", "padding": "8px", "padding-bottom": "2.5rem", "border-bottom": "3px dashed white", "margin": "8px"})})], (TMP_17 = function(){var self = TMP_17.$$s || this;

      return self.$text(self.$store().$policy_text())}, TMP_17.$$s = self, TMP_17.$$arity = 0, TMP_17));
      self.$render_download_button();
      return $send(self.$div().$footer(), 'container', [$hash2(["style"], {"style": $hash2(["position", "bottom", "left", "right", "padding"], {"position": "fixed", "bottom": "0px", "left": "0px", "right": "0px", "padding": "1rem"})})], (TMP_18 = function(){var self = TMP_18.$$s || this;

      
        self.$render_numeric_control("secrets", "Number of secrets:");
        return self.$render_numeric_control("annotations_per_secret", "Annotations per secret:");}, TMP_18.$$s = self, TMP_18.$$arity = 0, TMP_18));
    }, TMP_Policy_render_19.$$arity = 0), nil) && 'render';
  })($nesting[0], null, $nesting)
};
/* Generated by Opal 0.11.1 */
...
Opal.modules["lib/generator"] = function(Opal) {
  ...
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $send = Opal.send, $hash2 = Opal.hash2, $truthy = Opal.truthy, $hash = Opal.hash, $klass = Opal.klass;

  Opal.add_stubs(['$extend', '$join', '$map!', '$split', '$*', '$require', '$uuid', '$map', '$verticalList', '$==', '$length', '$first', '$<=', '$inlineList', '$indent', '$renderMembers', '$chop', '$verticalHash', '$include', '$>', '$lambda', '$makeUnique', '$-', '$call', '$[]', '$%', '$slice', '$yaml', '$user', '$group', '$grant', '$flatten', '$to_sym', '$variable']);
  return (function($base, $parent_nesting) {
    var $Conjur, self = $Conjur = $module($base, 'Conjur');
    ...
    (function($base, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_PolicyGenerator_indent_2, TMP_PolicyGenerator_makeUnique_3, TMP_PolicyGenerator_verticalList_5, TMP_PolicyGenerator_verticalHash_7, TMP_PolicyGenerator_inlineList_8, TMP_PolicyGenerator_yaml_9, TMP_PolicyGenerator_user_10, TMP_PolicyGenerator_group_11, TMP_PolicyGenerator_grant_13, TMP_PolicyGenerator_variable_14;
...
if (line == null) line = nil;
      ...
      Opal.defn(self, '$verticalList', TMP_PolicyGenerator_verticalList_5 = function $$verticalList($a_rest) {
        var TMP_4, self = this, children;
        ...
        return $send(children, 'map', [], (TMP_4 = function(child){var self = TMP_4.$$s || this;
if (child == null) child = nil;
        return "" + "- " + (child)}, TMP_4.$$s = self, TMP_4.$$arity = 1, TMP_4)).$join("\n")
      }, TMP_PolicyGenerator_verticalList_5.$$arity = -1);
      
      Opal.defn(self, '$verticalHash', TMP_PolicyGenerator_verticalHash_7 = function $$verticalHash($kwargs) {
        var TMP_6, self = this, pairs;
        ...
        return $send(pairs, 'map', [], (TMP_6 = function(key, val){var self = TMP_6.$$s || this;
if (key == null) key = nil;if (val == null) val = nil;
        return "" + (key) + ": " + (val)}, TMP_6.$$s = self, TMP_6.$$arity = 2, TMP_6)).$join("\n")
      }, TMP_PolicyGenerator_verticalHash_7.$$arity = -1);
      
      Opal.defn(self, '$inlineList', TMP_PolicyGenerator_inlineList_8 = function $$inlineList($a_rest) {
      ...
      }, TMP_PolicyGenerator_inlineList_8.$$arity = -1);
      
      Opal.defn(self, '$yaml', TMP_PolicyGenerator_yaml_9 = function $$yaml($a_rest) {
        var self = this, children;
      ...
      }, TMP_PolicyGenerator_yaml_9.$$arity = -1);
      
      Opal.defn(self, '$user', TMP_PolicyGenerator_user_10 = function $$user(name) {
        var self = this;

        return "" + "!user " + (name)
      }, TMP_PolicyGenerator_user_10.$$arity = 1);
      
      Opal.defn(self, '$group', TMP_PolicyGenerator_group_11 = function $$group(name) {
        var self = this;

        return "" + "!group " + (name)
      }, TMP_PolicyGenerator_group_11.$$arity = 1);
      
      Opal.defn(self, '$grant', TMP_PolicyGenerator_grant_13 = function $$grant(role, $a_rest) {
        var TMP_renderMembers_12, self = this, members, result = nil;
        ...
        Opal.def(self, '$renderMembers', TMP_renderMembers_12 = function $$renderMembers(members) {
          var self = this;
        ...
        }, TMP_renderMembers_12.$$arity = 1);
        result = "" + "!grant\n" + "  role: " + (role) + "\n" + "" + (self.$indent(self.$renderMembers(members))) + "\n";
        return result.$chop();
      }, TMP_PolicyGenerator_grant_13.$$arity = -2);
      
      Opal.defn(self, '$variable', TMP_PolicyGenerator_variable_14 = function $$variable(name, $kwargs) {
        ...
        result = "" + "!variable\n" + "  id: " + (name) + "\n" + "  annotations:\n" + "" + (self.$indent(self.$verticalHash(Opal.to_hash(annotations)), 4)) + "\n";
        return result.$chop();
      }, TMP_PolicyGenerator_variable_14.$$arity = -2);
      (function($base, $super, $parent_nesting) {
        function $Humans(){};
        var self = $Humans = $klass($base, $super, 'Humans', $Humans);

        var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Humans_initialize_15, TMP_Humans_toMAML_24;
        ...
        Opal.defn(self, '$initialize', TMP_Humans_initialize_15 = function $$initialize(users, groups, usersPerGroup) {
          var self = this;
        ...
        }, TMP_Humans_initialize_15.$$arity = -1);
        return (Opal.defn(self, '$toMAML', TMP_Humans_toMAML_24 = function $$toMAML() {
          var $a, TMP_16, TMP_17, TMP_18, TMP_19, TMP_20, TMP_21, TMP_22, self = this, numUserNames = nil, numGroupNames = nil, bigPolicy = nil, transform = nil, userStrings = nil, groupStrings = nil, grantObjects = nil;
          ...
          transform = $send(self, 'lambda', [], (TMP_16 = function(string){var self = TMP_16.$$s || this;
if (string == null) string = nil;
          if ($truthy(bigPolicy)) {
          ...
          userStrings = $send(Opal.Range.$new(0, $rb_minus(self.users, 1), false), 'map', [], (TMP_17 = function(index){var self = TMP_17.$$s || this;
if (index == null) index = nil;
          return transform.$call(Opal.const_get_relative($nesting, 'HUMAN_NAMES')['$[]'](index['$%'](numUserNames)))}, TMP_17.$$s = self, TMP_17.$$arity = 1, TMP_17));
          groupStrings = $send(Opal.Range.$new(0, $rb_minus(self.groups, 1), false), 'map', [], (TMP_18 = function(index){var self = TMP_18.$$s || this;
if (index == null) index = nil;
          return transform.$call(Opal.const_get_relative($nesting, 'ANIMAL_NAMES')['$[]'](index['$%'](numGroupNames)))}, TMP_18.$$s = self, TMP_18.$$arity = 1, TMP_18));
          if ($truthy($rb_le(self.usersPerGroup, 0))) {
            } else {
            grantObjects = $send(groupStrings, 'map', [], (TMP_19 = function(group){var self = TMP_19.$$s || this;
              if (self.usersPerGroup == null) self.usersPerGroup = nil;
if (group == null) group = nil;
            return $hash2(["role", "members"], {"role": group, "members": userStrings.$slice(0, self.usersPerGroup)})}, TMP_19.$$s = self, TMP_19.$$arity = 1, TMP_19))
          };
          grantObjects = ($truthy($a = grantObjects) ? $a : []);
          return $send(self, 'yaml', Opal.to_a($send(userStrings, 'map', [], (TMP_20 = function(name){var self = TMP_20.$$s || this;
if (name == null) name = nil;
          return self.$user(name)}, TMP_20.$$s = self, TMP_20.$$arity = 1, TMP_20))).concat(Opal.to_a($send(groupStrings, 'map', [], (TMP_21 = function(name){var self = TMP_21.$$s || this;
if (name == null) name = nil;
          return self.$group(name)}, TMP_21.$$s = self, TMP_21.$$arity = 1, TMP_21)))).concat(Opal.to_a($send(grantObjects, 'map', [], (TMP_22 = function(data){var self = TMP_22.$$s || this, TMP_23;
if (data == null) data = nil;
          return $send(self, 'grant', [self.$group(data['$[]']("role"))].concat(Opal.to_a($send(data['$[]']("members"), 'map', [], (TMP_23 = function(name){var self = TMP_23.$$s || this;
if (name == null) name = nil;
            return self.$user(name)}, TMP_23.$$s = self, TMP_23.$$arity = 1, TMP_23)))))}, TMP_22.$$s = self, TMP_22.$$arity = 1, TMP_22)))));
        }, TMP_Humans_toMAML_24.$$arity = 0), nil) && 'toMAML';
      })($nesting[0], null, $nesting);
      (function($base, $super, $parent_nesting) {
        function $Secrets(){};
        var self = $Secrets = $klass($base, $super, 'Secrets', $Secrets);

        var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Secrets_initialize_25, TMP_Secrets_toMAML_30;
        ...
        Opal.defn(self, '$initialize', TMP_Secrets_initialize_25 = function $$initialize(secrets, annotationsPerSecret) {
          var self = this;
        ...
        }, TMP_Secrets_initialize_25.$$arity = -1);
        return (Opal.defn(self, '$toMAML', TMP_Secrets_toMAML_30 = function $$toMAML() {
          var $a, TMP_26, TMP_27, TMP_28, TMP_29, self = this, numSecretNames = nil, numAnnotationNames = nil, bigPolicy = nil, transform = nil, secretStrings = nil, annotationHash = nil;
...
if (string == null) string = nil;
          ...
          secretStrings = $send(Opal.Range.$new(0, $rb_minus(self.secrets, 1), false), 'map', [], (TMP_27 = function(index){var self = TMP_27.$$s || this;
if (index == null) index = nil;
          return transform.$call(Opal.const_get_relative($nesting, 'VARIABLE_NAMES')['$[]'](index['$%'](numSecretNames)))}, TMP_27.$$s = self, TMP_27.$$arity = 1, TMP_27));
          annotationHash = $send(Opal.const_get_relative($nesting, 'Hash'), '[]', Opal.to_a($send(Opal.Range.$new(0, $rb_minus(self.annotationsPerSecret, 1), false), 'map', [], (TMP_28 = function(index){var self = TMP_28.$$s || this;
if (index == null) index = nil;
          return [transform.$call(Opal.const_get_relative($nesting, 'ANNOTATION_NAMES')['$[]'](index['$%'](numAnnotationNames))).$to_sym(), "value"]}, TMP_28.$$s = self, TMP_28.$$arity = 1, TMP_28)).$flatten()));
          return $send(self, 'yaml', Opal.to_a($send(secretStrings, 'map', [], (TMP_29 = function(name){var self = TMP_29.$$s || this;
if (name == null) name = nil;
          return self.$variable(name, Opal.to_hash(annotationHash))}, TMP_29.$$s = self, TMP_29.$$arity = 1, TMP_29))));
        }, TMP_Secrets_toMAML_30.$$arity = 0), nil) && 'toMAML';
      })($nesting[0], null, $nesting);
    })($nesting[0], $nesting)
  })($nesting[0], $nesting)
};
