...
Opal.modules["store"] = function(Opal) {
  ...
  Opal.add_stubs(['$include', '$attr_reader', '$change_generator', '$include?', '$supported_generators', '$raise', '$clone', '$dig', '$!', '$[]=', '$-', '$[]', '$+', '$value', '$toMAML', '$new', '$generator', '$values']);
  return (function($base, $super, $parent_nesting) {
    function $Store(){};
    var self = $Store = $klass($base, $super, 'Store', $Store);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Store_init_1, TMP_Store_supported_generators_2, TMP_Store_change_generator_3, TMP_Store_generator_4, TMP_Store_value_5, TMP_Store_increase_6, TMP_Store_decrease_7, TMP_Store_set_8, TMP_Store_policy_text_9;

    def.current_generator = def.variables = nil;
    ...
    Opal.defn(self, '$generator', TMP_Store_generator_4 = function $$generator() {
      var self = this;

      return self.$supported_generators().$dig(self.current_generator, "generator")
    }, TMP_Store_generator_4.$$arity = 0);
    
    Opal.defn(self, '$value', TMP_Store_value_5 = function $$value(variable) {
      var self = this, $writer = nil;

      
      if ($truthy(self.variables['$include?'](variable)['$!']())) {
        
        $writer = [variable, 0];
        $send(self.variables, '[]=', Opal.to_a($writer));
        $writer[$rb_minus($writer["length"], 1)];};
      return self.variables['$[]'](variable);
    }, TMP_Store_value_5.$$arity = 1);
    
    Opal.defn(self, '$increase', TMP_Store_increase_6 = function $$increase(variable) {
      var self = this, $writer = nil;

      
      $writer = [variable, $rb_plus(self.$value(variable), 1)];
      $send(self.variables, '[]=', Opal.to_a($writer));
      return $writer[$rb_minus($writer["length"], 1)];
    ...
    Opal.defn(self, '$decrease', TMP_Store_decrease_7 = function $$decrease(variable) {
      ...
      $writer = [variable, $rb_minus(self.$value(variable), 1)];
      $send(self.variables, '[]=', Opal.to_a($writer));
      return $writer[$rb_minus($writer["length"], 1)];
    ...
    Opal.defn(self, '$set', TMP_Store_set_8 = function $$set(variable, value) {
      ...
      $writer = [variable, value];
      $send(self.variables, '[]=', Opal.to_a($writer));
      return $writer[$rb_minus($writer["length"], 1)];
    }, TMP_Store_set_8.$$arity = 2);
    return (Opal.defn(self, '$policy_text', TMP_Store_policy_text_9 = function $$policy_text() {
      var self = this;

      return $send(self.$generator(), 'new', Opal.to_a(self.variables.$values())).$toMAML()
    }, TMP_Store_policy_text_9.$$arity = 0), nil) && 'policy_text';
  })($nesting[0], null, $nesting)
};
/* Generated by Opal 0.11.1 */
...
Opal.modules["components/generic/policy"] = function(Opal) {
  ...
  Opal.add_stubs(['$lambda', '$increase', '$store', '$render!', '$decrease', '$set', '$checked', '$target', '$value', '$mb_2', '$input_group', '$numeric_control', '$div', '$input_group_prepend', '$input_group_text', '$label', '$text', '$call', '$generic_control', '$form_control', '$input', '$update', '$btn_outline_secondary', '$btn', '$button', '$dec', '$text_center', '$input_group_append', '$inc', '$toggle', '$policy_text', '$a', '$input_group_btn', '$span', '$btn_default', '$bg_light', '$[]', '$props', '$h4', '$render_download_button', '$container', '$footer']);
  return (function($base, $parent_nesting) {
...
if (e == null) e = nil;
    ...
    Opal.defn(self, '$render_download_button', TMP_Policy_render_download_button_28 = function $$render_download_button() {
      ...
      data_encoded = btoa(self.$store().$policy_text());
...
Opal.modules["components/home"] = function(Opal) {
  ...
  Opal.add_stubs(['$include', '$div', '$current_generator', '$store', '$===', '$component', '$text', '$class']);
  return (function($base, $super, $parent_nesting) {
    function $Home(){};
    var self = $Home = $klass($base, $super, 'Home', $Home);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Home_render_2;

    
    self.$include(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Inesita'), 'Component'));
    return (Opal.defn(self, '$render', TMP_Home_render_2 = function $$render() {
      var TMP_1, self = this;

      return $send(self, 'div', [], (TMP_1 = function(){var self = TMP_1.$$s || this, $case = nil;
      ...
      return (function() {$case = self.$store().$current_generator();
        ...
        else {return self.$text("" + "Error: can't show the policy (" + (self.$store().$current_generator()) + ", " + (self.$store().$current_generator().$class()) + ")")}})()}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1))
    }, TMP_Home_render_2.$$arity = 0), nil) && 'render';
  })($nesting[0], null, $nesting)
};
/* Generated by Opal 0.11.1 */
