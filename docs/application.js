...
Opal.modules["store"] = function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Store_init_1, TMP_Store_supported_generators_2, TMP_Store_change_generator_3, TMP_Store_generator_4, TMP_Store_value_5, TMP_Store_increase_6, TMP_Store_decrease_7, TMP_Store_policy_text_8;
...
Opal.modules["components/generic/policy"] = function(Opal) {
  ...
  Opal.add_stubs(['$lambda', '$increase', '$store', '$render!', '$decrease', '$mb_2', '$input_group', '$numeric_control', '$div', '$input_group_prepend', '$input_group_text', '$label', '$text', '$btn_outline_secondary', '$btn', '$button', '$dec', '$text_center', '$form_control', '$input', '$value', '$input_group_append', '$inc', '$policy_text', '$a', '$input_group_btn', '$span', '$btn_default', '$[]', '$props', '$h4', '$render_download_button']);
  return (function($base, $parent_nesting) {
    var $Policy, self = $Policy = $module($base, 'Policy');

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Policy_inc_2, TMP_Policy_dec_4, TMP_Policy_render_numeric_control_11, TMP_Policy_render_download_button_15, TMP_Policy_render_policy_18;
    ...
    Opal.defn(self, '$render_numeric_control', TMP_Policy_render_numeric_control_11 = function $$render_numeric_control(variable, description) {
      ...
      return $send(self.$div().$numeric_control().$input_group(), 'mb_2', [], (TMP_5 = function(){var self = TMP_5.$$s || this, TMP_6, TMP_9;
    ...
    Opal.defn(self, '$render_policy', TMP_Policy_render_policy_18 = function $$render_policy() {
    ...
    }, TMP_Policy_render_policy_18.$$arity = 0);
  })($nesting[0], $nesting)
};
/* Generated by Opal 0.11.1 */
Opal.modules["components/home"] = function(Opal) {
  ...
  Opal.add_stubs(['$include', '$bg_light', '$div', '$current_generator', '$store', '$===', '$component', '$text', '$class']);
  return (function($base, $super, $parent_nesting) {
    function $Home(){};
    ...
    return (Opal.defn(self, '$render', TMP_Home_render_2 = function $$render() {
      ...
      return $send(self.$div(), 'bg_light', [$hash2(["style"], {"style": $hash2(["margin-bottom"], {"margin-bottom": "10rem"})})], (TMP_1 = function(){var self = TMP_1.$$s || this, $case = nil;

      return (function() {$case = self.$store().$current_generator();
        if ("secrets"['$===']($case)) {return self.$component(Opal.const_get_relative($nesting, 'SecretsPolicy'))}
...
Opal.modules["components/humans_policy"] = function(Opal) {
  ...
  Opal.add_stubs(['$include', '$render_policy', '$container', '$footer', '$div', '$render_numeric_control']);
  return (function($base, $super, $parent_nesting) {
    ...
    return (Opal.defn(self, '$render', TMP_HumansPolicy_render_2 = function $$render() {
      ...
      self.$render_policy();
      return $send(self.$div().$footer(), 'container', [$hash2(["style"], {"style": $hash2(["position", "bottom", "left", "right", "padding"], {"position": "fixed", "bottom": "0px", "left": "0px", "right": "0px", "padding": "1rem"})})], (TMP_1 = function(){var self = TMP_1.$$s || this;
