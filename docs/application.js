...
;
if (typeof(OpalLoaded) === 'undefined') OpalLoaded = []; OpalLoaded.push("vendor/virtual-dom");
/* Generated by Opal 0.11.1 */
Opal.modules["virtual_dom/dom"] = function(Opal) {
  function $rb_minus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs - rhs : lhs['$-'](rhs);
  }
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $send = Opal.send, $hash2 = Opal.hash2, $truthy = Opal.truthy, $range = Opal.range;
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_DOM_1, TMP_DOM_process_tag_3, TMP_DOM_method_missing_4, TMP_DOM_merge_string_6, TMP_DOM_process_params_8, TMP_DOM_event_callback_10, TMP_DOM_text_11, TMP_DOM_to_vnode_12, TMP_DOM_class_names_14;

      
      Opal.const_set($nesting[0], 'HTML_TAGS', ["a", "abbr", "address", "area", "article", "aside", "audio", "b", "base", "bdi", "bdo", "big", "blockquote", "body", "br", "button", "canvas", "caption", "cite", "code", "col", "colgroup", "data", "datalist", "dd", "del", "details", "dfn", "dialog", "div", "dl", "dt", "em", "embed", "fieldset", "figcaption", "figure", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hr", "html", "i", "iframe", "img", "input", "ins", "kbd", "keygen", "label", "legend", "li", "link", "main", "map", "mark", "menu", "menuitem", "meta", "meter", "nav", "noscript", "object", "ol", "optgroup", "option", "output", "p", "param", "picture", "pre", "progress", "q", "rp", "rt", "ruby", "s", "samp", "script", "section", "select", "small", "source", "span", "strong", "style", "sub", "summary", "sup", "table", "tbody", "td", "textarea", "tfoot", "th", "thead", "time", "title", "tr", "track", "u", "ul", "var", "video", "wbr"]);
      $send(Opal.const_get_relative($nesting, 'HTML_TAGS'), 'each', [], (TMP_DOM_1 = function(tag){var self = TMP_DOM_1.$$s || this, TMP_2;
if (tag == null) tag = nil;
      return $send(self, 'define_method', [tag], (TMP_2 = function(params){var self = TMP_2.$$s || this, block;
        ...
        if ($truthy(params['$is_a?'](Opal.const_get_relative($nesting, 'String')))) {
            return self.$process_tag(tag, $hash2([], {}), block, params)
          } else if ($truthy(params['$is_a?'](Opal.const_get_relative($nesting, 'Hash')))) {
            return self.$process_tag(tag, params, block)
            } else {
            return nil
          }}, TMP_2.$$s = self, TMP_2.$$arity = -1, TMP_2))}, TMP_DOM_1.$$s = self, TMP_DOM_1.$$arity = 1, TMP_DOM_1));
      
      Opal.defn(self, '$process_tag', TMP_DOM_process_tag_3 = function $$process_tag(tag, params, block, children) {
        var $a, self = this, current = nil, result = nil, vnode = nil;
        ...
        self.__virtual_nodes__ = ($truthy($a = self.__virtual_nodes__) ? $a : []);
        if ($truthy(block)) {
          
          current = self.__virtual_nodes__;
          self.__virtual_nodes__ = [];
          result = ($truthy($a = block.$call()) ? $a : children);
          vnode = Opal.const_get_relative($nesting, 'VirtualNode').$new(tag, self.$process_params(params), (function() {if ($truthy(self.__virtual_nodes__.$count()['$zero?']())) {
            return result
            } else {
          ...
          vnode = Opal.const_get_relative($nesting, 'VirtualNode').$new(tag, self.$process_params(params), children)
        };
        self.__last_virtual_node__ = vnode;
        self.__virtual_nodes__['$<<'](self.__last_virtual_node__.$to_n());
        return self;
      }, TMP_DOM_process_tag_3.$$arity = -4);
      
      Opal.defn(self, '$method_missing', TMP_DOM_method_missing_4 = function $$method_missing(clazz, params) {
        var self = this, $iter = TMP_DOM_method_missing_4.$$p, block = $iter || nil, children = nil, class_params = nil, method_params = nil;
        if (self.__last_virtual_node__ == null) self.__last_virtual_node__ = nil;
        if (self.__virtual_nodes__ == null) self.__virtual_nodes__ = nil;
        ...
        if ($iter) TMP_DOM_method_missing_4.$$p = null;
        ...
        method_params = (function() {if ($truthy(clazz['$end_with?']("!"))) {
          return $hash2(["id", "class"], {"id": clazz['$[]']($range(0, -2, false)), "class": self.$merge_string(class_params, params['$[]']("class"))})
          } else {
          return $hash2(["class"], {"class": self.$merge_string(class_params, params['$[]']("class"), clazz.$gsub("_", "-").$gsub("--", "_"))})
        }; return nil; })();
      ...
      }, TMP_DOM_method_missing_4.$$arity = -2);
      
      Opal.defn(self, '$merge_string', TMP_DOM_merge_string_6 = function $$merge_string($a_rest) {
        var TMP_5, self = this, params, arr = nil;
        ...
        arr = [];
        $send(params, 'each', [], (TMP_5 = function(string){var self = TMP_5.$$s || this;
if (string == null) string = nil;
          ...
          return arr['$<<'](string.$split(" "));}, TMP_5.$$s = self, TMP_5.$$arity = 1, TMP_5));
        return arr.$join(" ");
      }, TMP_DOM_merge_string_6.$$arity = -1);
      
      Opal.defn(self, '$process_params', TMP_DOM_process_params_8 = function $$process_params(params) {
        var TMP_7, self = this;

        
        $send(params.$dup(), 'each', [], (TMP_7 = function(k, v){var self = TMP_7.$$s || this, $case = nil, $writer = nil;
if (k == null) k = nil;if (v == null) v = nil;
        return (function() {$case = k;
          if ("for"['$===']($case)) {
          $writer = ["htmlFor", params.$delete("for")];
          $send(params, '[]=', Opal.to_a($writer));
          return $writer[$rb_minus($writer["length"], 1)];}
          else if ("class"['$===']($case)) {
          $writer = ["className", params.$delete("class")];
          $send(params, '[]=', Opal.to_a($writer));
          return $writer[$rb_minus($writer["length"], 1)];}
          else if ("data"['$===']($case)) {
          $writer = ["dataset", params.$delete("data")];
          $send(params, '[]=', Opal.to_a($writer));
          return $writer[$rb_minus($writer["length"], 1)];}
          else if ("default"['$===']($case)) {
          $writer = ["defaultValue", params.$delete("default")];
          $send(params, '[]=', Opal.to_a($writer));
          return $writer[$rb_minus($writer["length"], 1)];}
          else if (/^on/['$===']($case)) {
          $writer = [k, self.$event_callback(v)];
          $send(params, '[]=', Opal.to_a($writer));
          return $writer[$rb_minus($writer["length"], 1)];}
          else { return nil }})()}, TMP_7.$$s = self, TMP_7.$$arity = 2, TMP_7));
        return params;
      }, TMP_DOM_process_params_8.$$arity = 1);
      
      Opal.defn(self, '$event_callback', TMP_DOM_event_callback_10 = function $$event_callback(v) {
        var TMP_9, self = this;

        return $send(self, 'proc', [], (TMP_9 = function(e){var self = TMP_9.$$s || this;
if (e == null) e = nil;
        return v.$call(Opal.const_get_relative($nesting, 'Support').$wrap_event(e))}, TMP_9.$$s = self, TMP_9.$$arity = 1, TMP_9))
      }, TMP_DOM_event_callback_10.$$arity = 1);
      
      Opal.defn(self, '$text', TMP_DOM_text_11 = function $$text(string) {
        var self = this;
        if (self.__virtual_nodes__ == null) self.__virtual_nodes__ = nil;

        return self.__virtual_nodes__['$<<'](string.$to_s())
      }, TMP_DOM_text_11.$$arity = 1);
      
      Opal.defn(self, '$to_vnode', TMP_DOM_to_vnode_12 = function $$to_vnode() {
        var self = this;
        if (self.__virtual_nodes__ == null) self.__virtual_nodes__ = nil;
        ...
        if ($truthy(self.__virtual_nodes__['$one?']())) {
          ...
          return Opal.const_get_relative($nesting, 'VirtualNode').$new("div", $hash2([], {}), self.__virtual_nodes__).$to_n()
        }
      }, TMP_DOM_to_vnode_12.$$arity = 0);
      
      Opal.defn(self, '$class_names', TMP_DOM_class_names_14 = function $$class_names(hash) {
        var TMP_13, self = this, class_names = nil;

        
        class_names = [];
        $send(hash, 'each', [], (TMP_13 = function(key, value){var self = TMP_13.$$s || this;
if (key == null) key = nil;if (value == null) value = nil;
      ...
      }, TMP_DOM_class_names_14.$$arity = 1);
    })($nesting[0], $nesting)
  })($nesting[0], $nesting)
};
/* Generated by Opal 0.11.1 */
Opal.modules["virtual_dom/virtual_node"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_VirtualNode_initialize_1, TMP_VirtualNode_to_n_2, TMP_VirtualNode_to_s_3, TMP_VirtualNode_to_s_params_5, TMP_VirtualNode_to_s_children_6;

      def.name = def.params = def.children = nil;
      
      self.$attr_reader("name", "params", "children");
      
      Opal.defn(self, '$initialize', TMP_VirtualNode_initialize_1 = function $$initialize(name, params, children) {
        var self = this;
      ...
      }, TMP_VirtualNode_initialize_1.$$arity = -2);
      
      Opal.defn(self, '$to_n', TMP_VirtualNode_to_n_2 = function $$to_n() {
        var self = this;

        return virtualDom.h(self.name, self.params.$to_n(), self.children)
      }, TMP_VirtualNode_to_n_2.$$arity = 0);
      
      Opal.defn(self, '$to_s', TMP_VirtualNode_to_s_3 = function $$to_s() {
        var self = this;

        return "" + "<" + (self.name) + (self.$to_s_params()) + ">" + (self.$to_s_children()) + "</" + (self.name) + ">"
      }, TMP_VirtualNode_to_s_3.$$arity = 0);
      
      Opal.defn(self, '$to_s_params', TMP_VirtualNode_to_s_params_5 = function $$to_s_params() {
        var TMP_4, self = this;
        ...
        return $rb_plus(" ", $send(self.params, 'map', [], (TMP_4 = function(k, v){var self = TMP_4.$$s || this;
if (k == null) k = nil;if (v == null) v = nil;
        return "" + (k) + "=\"" + (v) + "\""}, TMP_4.$$s = self, TMP_4.$$arity = 2, TMP_4)).$join(" "));
      }, TMP_VirtualNode_to_s_params_5.$$arity = 0);
      return (Opal.defn(self, '$to_s_children', TMP_VirtualNode_to_s_children_6 = function $$to_s_children() {
        var self = this;

        
        if ($truthy(self.children['$is_a?'](Opal.const_get_relative($nesting, 'String')))) {
      ...
      }, TMP_VirtualNode_to_s_children_6.$$arity = 0), nil) && 'to_s_children';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting)
};
/* Generated by Opal 0.11.1 */
Opal.modules["virtual_dom/wrapper"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Wrapper_create_1, TMP_Wrapper_diff_2, TMP_Wrapper_patch_3;

      
      
      Opal.defn(self, '$create', TMP_Wrapper_create_1 = function $$create(vnode) {
        var self = this;

        return virtualDom.create(vnode)
      }, TMP_Wrapper_create_1.$$arity = 1);
      
      Opal.defn(self, '$diff', TMP_Wrapper_diff_2 = function $$diff(old, new$) {
        var self = this;

        return virtualDom.diff(old, new$)
      }, TMP_Wrapper_diff_2.$$arity = 2);
      
      Opal.defn(self, '$patch', TMP_Wrapper_patch_3 = function $$patch(dom, diff) {
        var self = this;

        return virtualDom.patch(dom, diff)
      }, TMP_Wrapper_patch_3.$$arity = 2);
    })($nesting[0], $nesting)
  })($nesting[0], $nesting)
};
/* Generated by Opal 0.11.1 */
Opal.modules["virtual_dom/hook"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_CommonHook_method_2, TMP_CommonHook_initialize_3, TMP_CommonHook_to_n_4, TMP_CommonHook_call_block_5;

      def.block = nil;
      
      Opal.defs(self, '$method', TMP_CommonHook_method_2 = function $$method(mthd) {
        var TMP_1, self = this;

        return $send(self, 'new', [], (TMP_1 = function(node, name, previous){var self = TMP_1.$$s || this;
if (node == null) node = nil;if (name == null) name = nil;if (previous == null) previous = nil;
        return mthd.$call(node, name, previous)}, TMP_1.$$s = self, TMP_1.$$arity = 3, TMP_1))
      }, TMP_CommonHook_method_2.$$arity = 1);
      
      Opal.defn(self, '$initialize', TMP_CommonHook_initialize_3 = function $$initialize() {
        var self = this, $iter = TMP_CommonHook_initialize_3.$$p, block = $iter || nil;

        if ($iter) TMP_CommonHook_initialize_3.$$p = null;
        return (self.block = block)
      }, TMP_CommonHook_initialize_3.$$arity = 0);
      
      Opal.defn(self, '$to_n', TMP_CommonHook_to_n_4 = function $$to_n() {
        var self = this;

        return self
      }, TMP_CommonHook_to_n_4.$$arity = 0);
      return (Opal.defn(self, '$call_block', TMP_CommonHook_call_block_5 = function $$call_block(node, name, previous) {
        var self = this;

        
        node = Opal.const_get_relative($nesting, 'Support').$wrap_node(node);
        name = self.$Native(name);
        previous = self.$Native(previous);
        return self.block.$call(node, name, previous);
      }, TMP_CommonHook_call_block_5.$$arity = 3), nil) && 'call_block';
    })($nesting[0], null, $nesting);
    (function($base, $super, $parent_nesting) {
      function $Hook(){};
    ...
    })($nesting[0], Opal.const_get_relative($nesting, 'CommonHook'), $nesting);
    (function($base, $super, $parent_nesting) {
      function $UnHook(){};
...
Opal.modules["virtual_dom/support"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Support_wrap_node_1, TMP_Support_wrap_event_2;

      
      self.$module_function();
      
      Opal.defn(self, '$wrap_node', TMP_Support_wrap_node_1 = function $$wrap_node(node) {
        var self = this;

        return self.$Native(node)
      }, TMP_Support_wrap_node_1.$$arity = 1);
      
      Opal.defn(self, '$wrap_event', TMP_Support_wrap_event_2 = function $$wrap_event(event) {
        var self = this;

        return self.$Native(event)
      }, TMP_Support_wrap_event_2.$$arity = 1);
    })($nesting[0], $nesting)
  })($nesting[0], $nesting)
};
/* Generated by Opal 0.11.1 */
Opal.modules["virtual_dom"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    self.$include(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'VirtualDOM'), 'DOM'));
    self.$extend(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'VirtualDOM'), 'Wrapper'));
  })($nesting[0], $nesting);
};
/* Generated by Opal 0.11.1 */
Opal.modules["inesita/browser"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Browser_animation_frame_1, TMP_Browser_animation_frame_2, TMP_Browser_ready$q_3, TMP_Browser_body_4, TMP_Browser_append_child_5, TMP_Browser_query_element_6;

      
      self.$module_function();
      Opal.const_set($nesting[0], 'Window', Opal.const_get_relative($nesting, 'JS').$global());
      Opal.const_set($nesting[0], 'Document', Opal.const_get_relative($nesting, 'Window')["document"]);
      Opal.const_set($nesting[0], 'AddEventListener', Opal.const_get_relative($nesting, 'Window')["addEventListener"]);
      if ($truthy(self.$Native(Opal.const_get_relative($nesting, 'Window')["requestAnimationFrame"]))) {
        
        Opal.defn(self, '$animation_frame', TMP_Browser_animation_frame_1 = function $$animation_frame() {
          var self = this, $iter = TMP_Browser_animation_frame_1.$$p, block = $iter || nil;

          if ($iter) TMP_Browser_animation_frame_1.$$p = null;
          return Opal.const_get_relative($nesting, 'Window').requestAnimationFrame(block)
        }, TMP_Browser_animation_frame_1.$$arity = 0)
        } else {
        
        Opal.defn(self, '$animation_frame', TMP_Browser_animation_frame_2 = function $$animation_frame() {
          var self = this, $iter = TMP_Browser_animation_frame_2.$$p, block = $iter || nil;

          if ($iter) TMP_Browser_animation_frame_2.$$p = null;
          return block.$call()
        }, TMP_Browser_animation_frame_2.$$arity = 0)
      };
      
      Opal.defn(self, '$ready?', TMP_Browser_ready$q_3 = function() {
        var self = this, $iter = TMP_Browser_ready$q_3.$$p, block = $iter || nil;

        if ($iter) TMP_Browser_ready$q_3.$$p = null;
        return Opal.const_get_relative($nesting, 'AddEventListener').$call("load", block)
      }, TMP_Browser_ready$q_3.$$arity = 0);
      
      Opal.defn(self, '$body', TMP_Browser_body_4 = function $$body() {
        var self = this;

        return Opal.const_get_relative($nesting, 'Document')["body"]
      }, TMP_Browser_body_4.$$arity = 0);
      
      Opal.defn(self, '$append_child', TMP_Browser_append_child_5 = function $$append_child(node, new_node) {
        var self = this;
      ...
      }, TMP_Browser_append_child_5.$$arity = 2);
      
      Opal.defn(self, '$query_element', TMP_Browser_query_element_6 = function $$query_element(css) {
        var self = this;

        return Opal.const_get_relative($nesting, 'Document').querySelector(css)
      }, TMP_Browser_query_element_6.$$arity = 1);
    })($nesting[0], $nesting)
  })($nesting[0], $nesting)
};
/* Generated by Opal 0.11.1 */
...
/* Generated by Opal 0.11.1 */
Opal.modules["inesita/injection"] = function(Opal) {
  function $rb_minus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs - rhs : lhs['$-'](rhs);
  }
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      var $Injection, self = $Injection = $module($base, 'Injection');

      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Injection_init_1, TMP_Injection_with_root_component_2, TMP_Injection_inject_5, TMP_Injection_init_injections_8, TMP_Injection_render$B_10;

      
      
      Opal.defn(self, '$init', TMP_Injection_init_1 = function $$init() {
        var self = this;

        return nil
      }, TMP_Injection_init_1.$$arity = 0);
      
      Opal.defn(self, '$with_root_component', TMP_Injection_with_root_component_2 = function $$with_root_component(component) {
        var self = this;

        
        self.root_component = component;
        return self;
      }, TMP_Injection_with_root_component_2.$$arity = 1);
      
      Opal.defn(self, '$inject', TMP_Injection_inject_5 = function $$inject() {
        var TMP_3, self = this;
        if (self.root_component == null) self.root_component = nil;

        
        $send(self.root_component.$injections(), 'each', [], (TMP_3 = function(name, instance){var self = TMP_3.$$s || this, TMP_4;
if (name == null) name = nil;if (instance == null) instance = nil;
        return $send(self, 'define_singleton_method', [name], (TMP_4 = function(){var self = TMP_4.$$s || this;

          return instance}, TMP_4.$$s = self, TMP_4.$$arity = 0, TMP_4))}, TMP_3.$$s = self, TMP_3.$$arity = 2, TMP_3));
        return self;
      }, TMP_Injection_inject_5.$$arity = 0);
      self.$attr_reader("injections");
      
      Opal.defn(self, '$init_injections', TMP_Injection_init_injections_8 = function $$init_injections() {
        var $a, TMP_6, TMP_7, self = this;
        if (self.injections == null) self.injections = nil;

        
        self.injections = ($truthy($a = self.injections) ? $a : $hash2([], {}));
        $send(self.$class().$injections(), 'each', [], (TMP_6 = function(name, clazz){var self = TMP_6.$$s || this, $writer = nil;
          if (self.root_component == null) self.root_component = nil;
          if (self.injections == null) self.injections = nil;
if (name == null) name = nil;if (clazz == null) clazz = nil;
        if ($truthy(clazz.$included_modules()['$include?'](Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Inesita'), 'Injection')))) {
            
            $writer = [name, clazz.$new().$with_root_component(self.root_component)];
            $send(self.injections, '[]=', Opal.to_a($writer));
            return $writer[$rb_minus($writer["length"], 1)];
            } else {
            return self.$raise(Opal.const_get_relative($nesting, 'Error'), "" + "Invalid " + (clazz) + " class, should mixin Inesita::Injection")
          }}, TMP_6.$$s = self, TMP_6.$$arity = 2, TMP_6));
        return $send(self.injections, 'each', [], (TMP_7 = function(key, instance){var self = TMP_7.$$s || this;
if (key == null) key = nil;if (instance == null) instance = nil;
        
          instance.$inject();
          return instance.$init();}, TMP_7.$$s = self, TMP_7.$$arity = 2, TMP_7));
      }, TMP_Injection_init_injections_8.$$arity = 0);
      
      Opal.defn(self, '$render!', TMP_Injection_render$B_10 = function() {
        var TMP_9, self = this;

        return $send(Opal.const_get_relative($nesting, 'Browser'), 'animation_frame', [], (TMP_9 = function(){var self = TMP_9.$$s || this;
          if (self.root_component == null) self.root_component = nil;

        return self.root_component.$render_if_root()}, TMP_9.$$s = self, TMP_9.$$arity = 0, TMP_9))
      }, TMP_Injection_render$B_10.$$arity = 0);
    })($nesting[0], $nesting)
  })($nesting[0], $nesting)
};
/* Generated by Opal 0.11.1 */
Opal.modules["inesita/component/class_methods"] = function(Opal) {
  function $rb_minus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs - rhs : lhs['$-'](rhs);
  }
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      ...
      (function($base, $parent_nesting) {
        ...
        var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_ClassMethods_mount_to_1, TMP_ClassMethods_inject_2, TMP_ClassMethods_injections_3;

        
        
        Opal.defn(self, '$mount_to', TMP_ClassMethods_mount_to_1 = function $$mount_to(element) {
          var self = this;

          return self.$new().$mount_to(element)
        }, TMP_ClassMethods_mount_to_1.$$arity = 1);
        
        Opal.defn(self, '$inject', TMP_ClassMethods_inject_2 = function $$inject(clazz, opts) {
          var $a, self = this, method_name = nil, $writer = nil;
          if (self.injections == null) self.injections = nil;
          ...
          method_name = ($truthy($a = opts['$[]']("as")) ? $a : clazz.$to_s().$downcase());
          self.injections = ($truthy($a = self.injections) ? $a : $hash2([], {}));
          
          $writer = [method_name, clazz];
          $send(self.injections, '[]=', Opal.to_a($writer));
          return $writer[$rb_minus($writer["length"], 1)];;
        }, TMP_ClassMethods_inject_2.$$arity = -2);
        
        Opal.defn(self, '$injections', TMP_ClassMethods_injections_3 = function $$injections() {
          var $a, self = this;
          if (self.injections == null) self.injections = nil;

          return ($truthy($a = self.injections) ? $a : $hash2([], {}))
        }, TMP_ClassMethods_injections_3.$$arity = 0);
      })($nesting[0], $nesting)
    })($nesting[0], $nesting)
  })($nesting[0], $nesting)
};
/* Generated by Opal 0.11.1 */
Opal.modules["inesita/component/virtual_dom"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      ...
      (function($base, $parent_nesting) {
        ...
        var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_VirtualDom_component_2, TMP_VirtualDom_hook_3, TMP_VirtualDom_unhook_4;

        
        
        Opal.defn(self, '$component', TMP_VirtualDom_component_2 = function $$component(comp, opts) {
          ...
          if ($truthy(comp['$nil?']())) {
            self.$raise(Opal.const_get_relative($nesting, 'Error'), "" + "Component is nil in " + (self.$class()) + " class")};
          self.__virtual_nodes__ = ($truthy($a = self.__virtual_nodes__) ? $a : []);
          self.__virtual_nodes__['$<<']($send(self, 'cache_component', [comp], (TMP_1 = function(){var self = TMP_1.$$s || this;
            if (self.root_component == null) self.root_component = nil;

          
            comp = (function() {if ($truthy(comp['$is_a?'](Opal.const_get_relative($nesting, 'Class')))) {
              return comp.$new()
              } else {
              return comp
            }; return nil; })().$with_root_component(self.root_component).$inject();
            comp.$init();
            return comp;}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1)).$with_props(($truthy($a = opts['$[]']("props")) ? $a : $hash2([], {}))).$render_virtual_dom());
          return self;
        }, TMP_VirtualDom_component_2.$$arity = -2);
        
        Opal.defn(self, '$hook', TMP_VirtualDom_hook_3 = function $$hook(mthd) {
          var self = this;

          return Opal.const_get_qualified(Opal.const_get_relative($nesting, 'VirtualDOM'), 'Hook').$method(self.$method(mthd))
        }, TMP_VirtualDom_hook_3.$$arity = 1);
        
        Opal.defn(self, '$unhook', TMP_VirtualDom_unhook_4 = function $$unhook(mthd) {
          var self = this;

          return Opal.const_get_qualified(Opal.const_get_relative($nesting, 'VirtualDOM'), 'UnHook').$method(self.$method(mthd))
        }, TMP_VirtualDom_unhook_4.$$arity = 1);
      })($nesting[0], $nesting)
    })($nesting[0], $nesting)
  })($nesting[0], $nesting)
};
/* Generated by Opal 0.11.1 */
Opal.modules["inesita/component/render"] = function(Opal) {
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $truthy = Opal.truthy;
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      ...
      (function($base, $parent_nesting) {
        ...
        var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Render_render_1, TMP_Render_render_if_root_2, TMP_Render_before_render_3, TMP_Render_render_virtual_dom_4;

        
        
        Opal.defn(self, '$render', TMP_Render_render_1 = function $$render() {
          var self = this;

          return self.$raise(Opal.const_get_relative($nesting, 'Error'), "" + "Implement #render in " + (self.$class()) + " component")
        }, TMP_Render_render_1.$$arity = 0);
        
        Opal.defn(self, '$render_if_root', TMP_Render_render_if_root_2 = function $$render_if_root() {
          var $a, self = this, new_virtual_dom = nil, diff = nil;
          if (self.virtual_dom == null) self.virtual_dom = nil;
          if (self.root_node == null) self.root_node = nil;

          
          if ($truthy(($truthy($a = self.virtual_dom) ? self.root_node : $a))) {
            } else {
            return nil
          };
          new_virtual_dom = self.$render_virtual_dom();
          diff = Opal.const_get_relative($nesting, 'VirtualDOM').$diff(self.virtual_dom, new_virtual_dom);
          Opal.const_get_relative($nesting, 'VirtualDOM').$patch(self.root_node, diff);
          return (self.virtual_dom = new_virtual_dom);
        }, TMP_Render_render_if_root_2.$$arity = 0);
        
        Opal.defn(self, '$before_render', TMP_Render_before_render_3 = function $$before_render() {
          var self = this;

          return nil
        }, TMP_Render_before_render_3.$$arity = 0);
        
        Opal.defn(self, '$render_virtual_dom', TMP_Render_render_virtual_dom_4 = function $$render_virtual_dom() {
          var self = this;
        ...
        }, TMP_Render_render_virtual_dom_4.$$arity = 0);
      })($nesting[0], $nesting)
    })($nesting[0], $nesting)
  })($nesting[0], $nesting)
};
/* Generated by Opal 0.11.1 */
Opal.modules["inesita/component/cache"] = function(Opal) {
  function $rb_plus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs + rhs : lhs['$+'](rhs);
  }
  function $rb_minus(lhs, rhs) {
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      ...
      (function($base, $parent_nesting) {
        var $Cache, self = $Cache = $module($base, 'Cache');

        var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Cache_cache_component_1;

        
        Opal.defn(self, '$cache_component', TMP_Cache_cache_component_1 = function $$cache_component(component) {
          var $a, self = this, $iter = TMP_Cache_cache_component_1.$$p, block = $iter || nil, $writer = nil;
          ...
          if ($iter) TMP_Cache_cache_component_1.$$p = null;
          
          self.cache_component = ($truthy($a = self.cache_component) ? $a : $hash2([], {}));
          self.cache_component_counter = ($truthy($a = self.cache_component_counter) ? $a : 0);
          self.cache_component_counter = $rb_plus(self.cache_component_counter, 1);
          return ($truthy($a = self.cache_component['$[]']("" + (component) + "-" + (self.cache_component_counter))) ? $a : (($writer = ["" + (component) + "-" + (self.cache_component_counter), block.$call()]), $send(self.cache_component, '[]=', Opal.to_a($writer)), $writer[$rb_minus($writer["length"], 1)]));
        }, TMP_Cache_cache_component_1.$$arity = 1)
      })($nesting[0], $nesting)
    })($nesting[0], $nesting)
  })($nesting[0], $nesting)
};
...
Opal.modules["inesita/component"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Component_included_1, TMP_Component_mount_to_2, TMP_Component_with_props_3;

      
      self.$include(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'VirtualDOM'), 'DOM'));
      self.$include(Opal.const_get_relative($nesting, 'VirtualDom'));
      self.$include(Opal.const_get_relative($nesting, 'Render'));
      self.$include(Opal.const_get_relative($nesting, 'Cache'));
      self.$include(Opal.const_get_relative($nesting, 'Injection'));
      Opal.defs(self, '$included', TMP_Component_included_1 = function $$included(base) {
        var self = this;

        return base.$extend(Opal.const_get_qualified(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Inesita'), 'Component'), 'ClassMethods'))
      }, TMP_Component_included_1.$$arity = 1);
      
      Opal.defn(self, '$mount_to', TMP_Component_mount_to_2 = function $$mount_to(element) {
        var self = this;
        if (self.virtual_dom == null) self.virtual_dom = nil;
        if (self.root_node == null) self.root_node = nil;
        ...
        if ($truthy(element)) {
          ...
          self.$raise(Opal.const_get_relative($nesting, 'Error'), "" + "Can't mount " + (self.$class()) + ", target element not found!")
        };
        self.root_component = self;
        self.$init_injections();
        self.$inject();
        self.virtual_dom = self.$render_virtual_dom();
        self.root_node = Opal.const_get_relative($nesting, 'VirtualDOM').$create(self.virtual_dom);
        Opal.const_get_relative($nesting, 'Browser').$append_child(element, self.root_node);
        return self;
      }, TMP_Component_mount_to_2.$$arity = 1);
      self.$attr_reader("props");
      
      Opal.defn(self, '$with_props', TMP_Component_with_props_3 = function $$with_props(props) {
        var self = this;

        
        self.props = props;
        return self;
      }, TMP_Component_with_props_3.$$arity = 1);
    })($nesting[0], $nesting)
  })($nesting[0], $nesting)
};
/* Generated by Opal 0.11.1 */
...
/* Generated by Opal 0.11.1 */
Opal.modules["inesita-router/browser"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Browser_path_1, TMP_Browser_query_2, TMP_Browser_decode_uri_component_3, TMP_Browser_push_state_4, TMP_Browser_on_pop_state_5, TMP_Browser_hash_change_6;

      
      self.$module_function();
      Opal.const_set($nesting[0], 'Location', Opal.const_get_relative($nesting, 'Document')["location"]);
      Opal.const_set($nesting[0], 'History', Opal.const_get_relative($nesting, 'Window')["history"]);
      
      Opal.defn(self, '$path', TMP_Browser_path_1 = function $$path() {
        var self = this;

        return Opal.const_get_relative($nesting, 'Location')["pathname"]
      }, TMP_Browser_path_1.$$arity = 0);
      
      Opal.defn(self, '$query', TMP_Browser_query_2 = function $$query() {
        var self = this;

        return Opal.const_get_relative($nesting, 'Location')["search"]
      }, TMP_Browser_query_2.$$arity = 0);
      
      Opal.defn(self, '$decode_uri_component', TMP_Browser_decode_uri_component_3 = function $$decode_uri_component(value) {
        var self = this;

        return Opal.const_get_relative($nesting, 'JS').$decodeURIComponent(value)
      }, TMP_Browser_decode_uri_component_3.$$arity = 1);
      
      Opal.defn(self, '$push_state', TMP_Browser_push_state_4 = function $$push_state(path) {
        var self = this;

        return Opal.const_get_relative($nesting, 'History').pushState($hash2([], {}), nil, path)
      }, TMP_Browser_push_state_4.$$arity = 1);
      
      Opal.defn(self, '$on_pop_state', TMP_Browser_on_pop_state_5 = function $$on_pop_state() {
        var self = this, $iter = TMP_Browser_on_pop_state_5.$$p, block = $iter || nil;

        if ($iter) TMP_Browser_on_pop_state_5.$$p = null;
        return Opal.const_get_relative($nesting, 'Window')["onpopstate"] = block
      }, TMP_Browser_on_pop_state_5.$$arity = 0);
      
      Opal.defn(self, '$hash_change', TMP_Browser_hash_change_6 = function $$hash_change() {
        var self = this, $iter = TMP_Browser_hash_change_6.$$p, block = $iter || nil;

        if ($iter) TMP_Browser_hash_change_6.$$p = null;
        return Opal.const_get_relative($nesting, 'AddEventListener').$call("hashchange", block)
      }, TMP_Browser_hash_change_6.$$arity = 0);
    })($nesting[0], $nesting)
  })($nesting[0], $nesting)
};
/* Generated by Opal 0.11.1 */
Opal.modules["inesita-router/routes"] = function(Opal) {
  function $rb_plus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs + rhs : lhs['$+'](rhs);
  }
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Routes_initialize_1, TMP_Routes_route_2, TMP_Routes_validate_component_3, TMP_Routes_add_redirect_4, TMP_Routes_add_route_5, TMP_Routes_add_subroutes_6, TMP_Routes_build_params_and_regex_8;

      def.parent = def.routes = nil;
      
      self.$attr_reader("routes");
      
      Opal.defn(self, '$initialize', TMP_Routes_initialize_1 = function $$initialize(parent) {
        var self = this;
        ...
        self.parent = parent;
        return (self.routes = []);
      }, TMP_Routes_initialize_1.$$arity = -1);
      
      Opal.defn(self, '$route', TMP_Routes_route_2 = function $$route($a_rest) {
        var self = this, params, $iter = TMP_Routes_route_2.$$p, block = $iter || nil, path = nil;
        ...
        if ($iter) TMP_Routes_route_2.$$p = null;
        
        path = params.$first().$gsub(/^\//, "");
        path = (function() {if ($truthy(self.parent)) {
      ...
      }, TMP_Routes_route_2.$$arity = -1);
      
      Opal.defn(self, '$validate_component', TMP_Routes_validate_component_3 = function $$validate_component(component) {
        var self = this;

        
        if ($truthy(component)) {
          } else {
          self.$raise(Opal.const_get_relative($nesting, 'Error'), "Component not exists")
        };
        if ($truthy(component['$include?'](Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Inesita'), 'Component')))) {
          return nil
          } else {
          return self.$raise(Opal.const_get_relative($nesting, 'Error'), "" + "Invalid " + (component) + " class, should mixin Inesita::Component")
        };
      }, TMP_Routes_validate_component_3.$$arity = 1);
      
      Opal.defn(self, '$add_redirect', TMP_Routes_add_redirect_4 = function $$add_redirect(path, redirect_to) {
        var self = this;

        return self.routes['$<<']($hash2(["path", "redirect_to"], {"path": path, "redirect_to": redirect_to}).$merge(self.$build_params_and_regex(path)))
      }, TMP_Routes_add_redirect_4.$$arity = 2);
      
      Opal.defn(self, '$add_route', TMP_Routes_add_route_5 = function $$add_route(name, path, component, component_props, on_enter) {
        var $a, self = this;

        
        self.$validate_component(component);
        return self.routes['$<<']($hash2(["path", "component", "component_props", "on_enter", "name"], {"path": path, "component": component, "component_props": component_props, "on_enter": on_enter, "name": ($truthy($a = name) ? $a : component.$to_s().$gsub(/(.)([A-Z])/, "\\1_\\2").$downcase())}).$merge(self.$build_params_and_regex(path)));
      }, TMP_Routes_add_route_5.$$arity = 5);
      
      Opal.defn(self, '$add_subroutes', TMP_Routes_add_subroutes_6 = function $$add_subroutes(path) {
        var self = this, $iter = TMP_Routes_add_subroutes_6.$$p, block = $iter || nil, subroutes = nil;

        if ($iter) TMP_Routes_add_subroutes_6.$$p = null;
        
        subroutes = Opal.const_get_relative($nesting, 'Routes').$new(path);
        $send(subroutes, 'instance_exec', [], block.$to_proc());
        return (self.routes = $rb_plus(self.routes, subroutes.$routes()));
      }, TMP_Routes_add_subroutes_6.$$arity = 1);
      return (Opal.defn(self, '$build_params_and_regex', TMP_Routes_build_params_and_regex_8 = function $$build_params_and_regex(path) {
        var TMP_7, self = this, regex = nil, params = nil, parts = nil;
        ...
        if ($truthy(parts['$empty?']())) {
          regex['$<<']("\\/")};
        (function(){var $brk = Opal.new_brk(); try {return $send(parts, 'each', [], (TMP_7 = function(part){var self = TMP_7.$$s || this, $case = nil;
if (part == null) part = nil;
        
          if ($truthy(part['$empty?']())) {
            return nil;};
          regex['$<<']("\\/");
          return (function() {$case = part['$[]'](0);
          if (":"['$===']($case)) {
          ...
          Opal.brk(nil, $brk);}
          else {return regex['$<<'](part)}})();}, TMP_7.$$s = self, TMP_7.$$brk = $brk, TMP_7.$$arity = 1, TMP_7))
        } catch (err) { if (err === $brk) { return err.$v } else { throw err } }})();
        regex['$<<']("$");
        return $hash2(["regex", "params"], {"regex": Opal.const_get_relative($nesting, 'Regexp').$new(regex.$join()), "params": params});
      }, TMP_Routes_build_params_and_regex_8.$$arity = 1), nil) && 'build_params_and_regex';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting)
};
/* Generated by Opal 0.11.1 */
Opal.modules["inesita-router/router"] = function(Opal) {
  function $rb_minus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs - rhs : lhs['$-'](rhs);
  }
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Router_initialize_1, TMP_Router_included_5, TMP_Router_add_listeners_8, TMP_Router_route_9, TMP_Router_find_route_11, TMP_Router_find_component_12, TMP_Router_render_13, TMP_Router_call_on_enter_callback_14, TMP_Router_go_to_15, TMP_Router_parse_url_params_17, TMP_Router_compotent_url_params_18, TMP_Router_url_for_20, TMP_Router_query_21, TMP_Router_path_22, TMP_Router_current_url$q_23, TMP_Router_url_with_params_25;

      
      self.$include(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Inesita'), 'Component'));
      self.$attr_reader("params");
      
      Opal.defn(self, '$initialize', TMP_Router_initialize_1 = function $$initialize() {
        var self = this;
        if (self.routes == null) self.routes = nil;

        
        self.routes = Opal.const_get_relative($nesting, 'Routes').$new();
        if ($truthy(self['$respond_to?']("routes"))) {
          } else {
          self.$raise(Opal.const_get_relative($nesting, 'Error'), "Add #routes method to router!")
        };
        self.$routes();
        if ($truthy(self.routes.$routes()['$empty?']())) {
          self.$raise(Opal.const_get_relative($nesting, 'Error'), "Add #route to your #routes method!")};
        self.$find_route();
        self.$parse_url_params();
        return self.$add_listeners();
      }, TMP_Router_initialize_1.$$arity = 0);
      Opal.defs(self, '$included', TMP_Router_included_5 = function $$included(base) {
        var TMP_2, self = this;

        
        base.$extend(Opal.const_get_qualified(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Inesita'), 'Component'), 'ClassMethods'));
        return $send(Opal.const_get_relative($nesting, 'Component'), 'module_eval', [], (TMP_2 = function(){var self = TMP_2.$$s || this, TMP_3;
        ...
        if ($truthy(self['$respond_to?']("__a"))) {
            ...
            return $send(self, 'define_method', ["a"], (TMP_3 = function(params){var self = TMP_3.$$s || this, block, TMP_4;
              ...
              params = $hash2(["onclick"], {"onclick": $send(self, 'lambda', [], (TMP_4 = function(e){var self = TMP_4.$$s || this;
if (e == null) e = nil;
              if (params['$[]']("target")['$==']("_blank")) {
                  return nil
                  } else {
                  return self.$router().$go_to(e.$target().$pathname())
                }}, TMP_4.$$s = self, TMP_4.$$arity = 1, TMP_4))}).$merge(params);
              return $send(self, '__a', [params], block.$to_proc());}, TMP_3.$$s = self, TMP_3.$$arity = -1, TMP_3));
          }}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2));
      }, TMP_Router_included_5.$$arity = 1);
      
      Opal.defn(self, '$add_listeners', TMP_Router_add_listeners_8 = function $$add_listeners() {
        var TMP_6, TMP_7, self = this;

        
        $send(Opal.const_get_relative($nesting, 'Browser'), 'on_pop_state', [], (TMP_6 = function(){var self = TMP_6.$$s || this;

        
          self.$find_route();
          self.$parse_url_params();
          return self['$render!']();}, TMP_6.$$s = self, TMP_6.$$arity = 0, TMP_6));
        return $send(Opal.const_get_relative($nesting, 'Browser'), 'hash_change', [], (TMP_7 = function(){var self = TMP_7.$$s || this;

        
          self.$find_route();
          self.$parse_url_params();
          return self['$render!']();}, TMP_7.$$s = self, TMP_7.$$arity = 0, TMP_7));
      }, TMP_Router_add_listeners_8.$$arity = 0);
      
      Opal.defn(self, '$route', TMP_Router_route_9 = function $$route($a_rest) {
        var self = this, params, $iter = TMP_Router_route_9.$$p, block = $iter || nil;
        if (self.routes == null) self.routes = nil;
        ...
        if ($iter) TMP_Router_route_9.$$p = null;
        return $send(self.routes, 'route', Opal.to_a(params), block.$to_proc())
      }, TMP_Router_route_9.$$arity = -1);
      
      Opal.defn(self, '$find_route', TMP_Router_find_route_11 = function $$find_route() {try {

        var TMP_10, self = this;
        if (self.routes == null) self.routes = nil;

        
        $send(self.routes.$routes(), 'each', [], (TMP_10 = function(route){var self = TMP_10.$$s || this;
if (route == null) route = nil;
          ...
          Opal.ret((self.route = route));}, TMP_10.$$s = self, TMP_10.$$arity = 1, TMP_10));
        return self.$raise(Opal.const_get_relative($nesting, 'Error'), "Can't find route for url");
        } catch ($returner) { if ($returner === Opal.returner) { return $returner.$v } throw $returner; }
      }, TMP_Router_find_route_11.$$arity = 0);
      
      Opal.defn(self, '$find_component', TMP_Router_find_component_12 = function $$find_component(route) {
        var self = this;
      ...
      }, TMP_Router_find_component_12.$$arity = 1);
      
      Opal.defn(self, '$render', TMP_Router_render_13 = function $$render() {
        var self = this;
      ...
      }, TMP_Router_render_13.$$arity = 0);
      
      Opal.defn(self, '$call_on_enter_callback', TMP_Router_call_on_enter_callback_14 = function $$call_on_enter_callback(route) {
        var self = this;
      ...
      }, TMP_Router_call_on_enter_callback_14.$$arity = 1);
      
      Opal.defn(self, '$go_to', TMP_Router_go_to_15 = function $$go_to(path) {
        var self = this;

        
        Opal.const_get_relative($nesting, 'Browser').$push_state(path);
        self.$find_route();
        self.$parse_url_params();
        self['$render!']();
        return false;
      }, TMP_Router_go_to_15.$$arity = 1);
      
      Opal.defn(self, '$parse_url_params', TMP_Router_parse_url_params_17 = function $$parse_url_params() {
        ...
        if ($truthy(self.$query()['$empty?']())) {
          ...
          return $send(self.$query()['$[]']($range(1, -1, false)).$split("&"), 'each', [], (TMP_16 = function(param){var self = TMP_16.$$s || this, $a, $b, key = nil, value = nil, $writer = nil;
...
if (param == null) param = nil;
            ...
            $writer = [Opal.const_get_relative($nesting, 'Browser').$decode_uri_component(key), Opal.const_get_relative($nesting, 'Browser').$decode_uri_component(value)];
            $send(self.params, '[]=', Opal.to_a($writer));
            return $writer[$rb_minus($writer["length"], 1)];;}, TMP_16.$$s = self, TMP_16.$$arity = 1, TMP_16))
        };
      }, TMP_Router_parse_url_params_17.$$arity = 0);
      
      Opal.defn(self, '$compotent_url_params', TMP_Router_compotent_url_params_18 = function $$compotent_url_params() {
        var self = this;
        if (self.route == null) self.route = nil;

        return Opal.const_get_relative($nesting, 'Hash')['$[]'](self.route['$[]']("params").$zip(self.$path().$match(self.route['$[]']("regex"))['$[]']($range(1, -1, false))))
      }, TMP_Router_compotent_url_params_18.$$arity = 0);
      
      Opal.defn(self, '$url_for', TMP_Router_url_for_20 = function $$url_for(name, params) {
        var TMP_19, self = this, route = nil;
        if (self.routes == null) self.routes = nil;
        ...
        route = $send(self.routes.$routes(), 'find', [], (TMP_19 = function(r){var self = TMP_19.$$s || this, $a, $case = nil;
if (r == null) r = nil;
        return (function() {$case = name;
          if (Opal.const_get_relative($nesting, 'String')['$===']($case)) {return ($truthy($a = r['$[]']("name")['$=='](name)) ? $a : r['$[]']("path")['$=='](name))}
          else if (Opal.const_get_relative($nesting, 'Object')['$===']($case)) {return r['$[]']("component")['$=='](name)}
          else {return false}})()}, TMP_19.$$s = self, TMP_19.$$arity = 1, TMP_19));
        if ($truthy(route)) {
          return self.$url_with_params(route, params)
          } else {
          return self.$raise(Opal.const_get_relative($nesting, 'Error'), "" + "Route '" + (name) + "' not found.")
        };
      }, TMP_Router_url_for_20.$$arity = -2);
      
      Opal.defn(self, '$query', TMP_Router_query_21 = function $$query() {
        var self = this;

        return Opal.const_get_relative($nesting, 'Browser').$query()
      }, TMP_Router_query_21.$$arity = 0);
      
      Opal.defn(self, '$path', TMP_Router_path_22 = function $$path() {
        var self = this;

        return Opal.const_get_relative($nesting, 'Browser').$path()
      }, TMP_Router_path_22.$$arity = 0);
      
      Opal.defn(self, '$current_url?', TMP_Router_current_url$q_23 = function(name) {
        var self = this;

        return self.$path()['$=='](self.$url_for(name, self.$params()))
      }, TMP_Router_current_url$q_23.$$arity = 1);
      
      Opal.defn(self, '$url_with_params', TMP_Router_url_with_params_25 = function $$url_with_params(route, params) {
        var TMP_24, self = this, path = nil;

        
        path = route['$[]']("path");
        if ($truthy(params)) {
          $send(params, 'each', [], (TMP_24 = function(key, value){var self = TMP_24.$$s || this;
if (key == null) key = nil;if (value == null) value = nil;
          return (path = path.$gsub("" + ":" + (key), "" + (value)))}, TMP_24.$$s = self, TMP_24.$$arity = 2, TMP_24))};
        return path;
      }, TMP_Router_url_with_params_25.$$arity = 2);
    })($nesting[0], $nesting)
  })($nesting[0], $nesting)
};
/* Generated by Opal 0.11.1 */
...
Opal.modules["router"] = function(Opal) {
  ...
  Opal.add_stubs(['$include', '$route', '$lambda', '$go_to']);
  return (function($base, $super, $parent_nesting) {
    function $Router(){};
    var self = $Router = $klass($base, $super, 'Router', $Router);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Router_routes_2;

    
    self.$include(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Inesita'), 'Router'));
    return (Opal.defn(self, '$routes', TMP_Router_routes_2 = function $$routes() {
      var TMP_1, self = this;

      
      self.$route("/conjur-policy-generator/about", $hash2(["to"], {"to": Opal.const_get_relative($nesting, 'About')}));
      self.$route("/conjur-policy-generator/?", $hash2(["to"], {"to": Opal.const_get_relative($nesting, 'Home')}));
      return self.$route("/", $hash2(["to", "on_enter"], {"to": Opal.const_get_relative($nesting, 'Home'), "on_enter": $send(self, 'lambda', [], (TMP_1 = function(){var self = TMP_1.$$s || this;

      return self.$go_to("/conjur-policy-generator/")}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1))}));
    }, TMP_Router_routes_2.$$arity = 0), nil) && 'routes';
  })($nesting[0], null, $nesting)
};
/* Generated by Opal 0.11.1 */
Opal.modules["store"] = function(Opal) {
  ...
  Opal.add_stubs(['$include', '$attr_reader', '$change_generator', '$infinity', '$include?', '$supported_generators', '$raise', '$clone', '$dig', '$[]', '$current_generator', '$nil?', '$clamp', '$set', '$+', '$value', '$-', '$[]=', '$toMAML', '$new', '$values', '$private']);
  return (function($base, $super, $parent_nesting) {
    function $Store(){};
    var self = $Store = $klass($base, $super, 'Store', $Store);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Store_init_1, TMP_Store_supported_generators_2, TMP_Store_change_generator_3, TMP_Store_value_4, TMP_Store_clamp_5, TMP_Store_increase_6, TMP_Store_decrease_7, TMP_Store_set_8, TMP_Store_policy_text_9, TMP_Store_infinity_10;

    def.variables = def.current_generator = nil;
    
    self.$include(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Inesita'), 'Injection'));
    self.$attr_reader("current_generator");
    self.$attr_reader("supported_generators");
    
    Opal.defn(self, '$init', TMP_Store_init_1 = function $$init() {
      var self = this;

      return self.$change_generator("secret_control")
    }, TMP_Store_init_1.$$arity = 0);
    
    Opal.defn(self, '$supported_generators', TMP_Store_supported_generators_2 = function $$supported_generators() {
      var self = this;

      return $hash2(["secret_control", "humans", "secrets"], {"secret_control": $hash2(["generator", "name", "defaults", "clamp"], {"generator": Opal.const_get_qualified(Opal.const_get_qualified(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Conjur'), 'PolicyGenerator'), 'Template'), 'SecretControl'), "name": "Secret Control", "defaults": $hash2(["application_name", "secret_groups", "secrets_per_group", "include_hostfactory"], {"application_name": "myapp", "secret_groups": 1, "secrets_per_group": 1, "include_hostfactory": false}), "clamp": $hash2(["secret_groups", "secrets_per_group"], {"secret_groups": [1, self.$infinity()], "secrets_per_group": [1, self.$infinity()]})}), "humans": $hash2(["generator", "name", "defaults", "clamp"], {"generator": Opal.const_get_qualified(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Conjur'), 'PolicyGenerator'), 'Humans'), "name": "Humans & Groups", "defaults": $hash2(["users", "groups", "users_per_group"], {"users": 2, "groups": 1, "users_per_group": 1}), "clamp": $hash2(["users", "groups", "users_per_group"], {"users": [1, self.$infinity()], "groups": [0, self.$infinity()], "users_per_group": [0, self.$infinity()]})}), "secrets": $hash2(["generator", "name", "defaults", "clamp"], {"generator": Opal.const_get_qualified(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Conjur'), 'PolicyGenerator'), 'Secrets'), "name": "Secrets Only", "defaults": $hash2(["secrets", "annotations_per_secret"], {"secrets": 1, "annotations_per_secret": 1}), "clamp": $hash2(["secrets", "annotations_per_secret"], {"secrets": [1, self.$infinity()], "annotations_per_secret": [0, self.$infinity()]})})})
    }, TMP_Store_supported_generators_2.$$arity = 0);
    
    Opal.defn(self, '$change_generator', TMP_Store_change_generator_3 = function $$change_generator(new_generator) {
      var self = this;

      
      if ($truthy(self.$supported_generators()['$include?'](new_generator))) {
        } else {
        self.$raise()
      };
      self.current_generator = new_generator;
      return (self.variables = self.$supported_generators().$dig(new_generator, "defaults").$clone());
    }, TMP_Store_change_generator_3.$$arity = 1);
    
    Opal.defn(self, '$value', TMP_Store_value_4 = function $$value(variable) {
      var self = this;

      return self.variables['$[]'](variable)
    }, TMP_Store_value_4.$$arity = 1);
    
    Opal.defn(self, '$clamp', TMP_Store_clamp_5 = function $$clamp(variable, value) {
      var self = this, bounds = nil;

      
      bounds = self.$supported_generators().$dig(self.$current_generator(), "clamp", variable);
      if ($truthy(bounds['$nil?']())) {
        return value};
      return $send(value, 'clamp', Opal.to_a(bounds));
    }, TMP_Store_clamp_5.$$arity = 2);
    
    Opal.defn(self, '$increase', TMP_Store_increase_6 = function $$increase(variable) {
      var self = this;

      return self.$set(variable, $rb_plus(self.$value(variable), 1))
    }, TMP_Store_increase_6.$$arity = 1);
    
    Opal.defn(self, '$decrease', TMP_Store_decrease_7 = function $$decrease(variable) {
      var self = this;

      return self.$set(variable, $rb_minus(self.$value(variable), 1))
    }, TMP_Store_decrease_7.$$arity = 1);
    
    Opal.defn(self, '$set', TMP_Store_set_8 = function $$set(variable, value) {
      var self = this, $writer = nil;

      
      $writer = [variable, self.$clamp(variable, value)];
      $send(self.variables, '[]=', Opal.to_a($writer));
      return $writer[$rb_minus($writer["length"], 1)];
    }, TMP_Store_set_8.$$arity = 2);
    
    Opal.defn(self, '$policy_text', TMP_Store_policy_text_9 = function $$policy_text() {
      var self = this;

      return $send(self.$supported_generators().$dig(self.current_generator, "generator"), 'new', Opal.to_a(self.variables.$values())).$toMAML()
    }, TMP_Store_policy_text_9.$$arity = 0);
    self.$private();
    return (Opal.defn(self, '$infinity', TMP_Store_infinity_10 = function $$infinity() {
      var self = this;

      return Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Float'), 'INFINITY')
    }, TMP_Store_infinity_10.$$arity = 0), nil) && 'infinity';
  })($nesting[0], null, $nesting)
};
/* Generated by Opal 0.11.1 */
...
/* Generated by Opal 0.11.1 */
Opal.modules["components/about"] = function(Opal) {
  ...
  Opal.add_stubs(['$include', '$bg_light', '$text_center', '$jumbotron', '$div', '$p', '$text', '$br', '$a']);
  return (function($base, $super, $parent_nesting) {
    function $About(){};
    var self = $About = $klass($base, $super, 'About', $About);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_About_render_4;

    
    self.$include(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Inesita'), 'Component'));
    return (Opal.defn(self, '$render', TMP_About_render_4 = function $$render() {
      var TMP_1, self = this;

      return $send(self.$div().$jumbotron().$text_center(), 'bg_light', [], (TMP_1 = function(){var self = TMP_1.$$s || this, TMP_2;

      return $send(self, 'p', [], (TMP_2 = function(){var self = TMP_2.$$s || this, TMP_3;

        
          self.$text("This is a proof of concept web UI for the Conjur policy generator.");
          self.$br();
          self.$text("You can find the source code, report a bug, or open an issue ");
          $send(self, 'a', [$hash2(["href"], {"href": "https://github.com/cyberark/conjur-policy-generator"})], (TMP_3 = function(){var self = TMP_3.$$s || this;

          return self.$text("on GitHub")}, TMP_3.$$s = self, TMP_3.$$arity = 0, TMP_3));
          return self.$text(".");}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2))}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1))
    }, TMP_About_render_4.$$arity = 0), nil) && 'render';
  })($nesting[0], null, $nesting)
};
/* Generated by Opal 0.11.1 */
Opal.modules["components/generic/policy"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Policy_inc_2, TMP_Policy_dec_4, TMP_Policy_toggle_6, TMP_Policy_update_8, TMP_Policy_generic_control_9, TMP_Policy_render_text_control_15, TMP_Policy_render_numeric_control_21, TMP_Policy_render_boolean_control_24, TMP_Policy_render_download_button_28, TMP_Policy_render_policy_32, TMP_Policy_render_footer_33;

    
    
    Opal.defn(self, '$inc', TMP_Policy_inc_2 = function $$inc(variable) {
      var TMP_1, self = this;

      return $send(self, 'lambda', [], (TMP_1 = function(){var self = TMP_1.$$s || this;

      
        self.$store().$increase(variable);
        return self['$render!']();}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1))
    }, TMP_Policy_inc_2.$$arity = 1);
    
    Opal.defn(self, '$dec', TMP_Policy_dec_4 = function $$dec(variable) {
      var TMP_3, self = this;

      return $send(self, 'lambda', [], (TMP_3 = function(){var self = TMP_3.$$s || this;

      
        self.$store().$decrease(variable);
        return self['$render!']();}, TMP_3.$$s = self, TMP_3.$$arity = 0, TMP_3))
    }, TMP_Policy_dec_4.$$arity = 1);
    
    Opal.defn(self, '$toggle', TMP_Policy_toggle_6 = function $$toggle(variable) {
      var TMP_5, self = this;

      return $send(self, 'lambda', [], (TMP_5 = function(e){var self = TMP_5.$$s || this;
if (e == null) e = nil;
      
        self.$store().$set(variable, e.$target().$checked());
        return self['$render!']();}, TMP_5.$$s = self, TMP_5.$$arity = 1, TMP_5))
    }, TMP_Policy_toggle_6.$$arity = 1);
    
    Opal.defn(self, '$update', TMP_Policy_update_8 = function $$update(variable) {
      var TMP_7, self = this;

      return $send(self, 'lambda', [], (TMP_7 = function(e){var self = TMP_7.$$s || this;
if (e == null) e = nil;
      
        self.$store().$set(variable, e.$target().$value());
        return self['$render!']();}, TMP_7.$$s = self, TMP_7.$$arity = 1, TMP_7))
    }, TMP_Policy_update_8.$$arity = 1);
    
    Opal.defn(self, '$generic_control', TMP_Policy_generic_control_9 = function $$generic_control(description, extra_prepend) {
      var TMP_10, self = this, TMP_13, $iter = TMP_Policy_generic_control_9.$$p, block = $iter || nil;

      if (extra_prepend == null) {
        extra_prepend = $send(self, 'lambda', [], (TMP_13 = function(){var self = TMP_13.$$s || this;
      ...
      return $send(self.$div().$numeric_control().$input_group(), 'mb_2', [], (TMP_10 = function(){var self = TMP_10.$$s || this, TMP_11;
        ...
        $send(self.$div(), 'input_group_prepend', [], (TMP_11 = function(){var self = TMP_11.$$s || this, TMP_12;
          ...
          $send(self.$label(), 'input_group_text', [], (TMP_12 = function(){var self = TMP_12.$$s || this;

          return self.$text(description)}, TMP_12.$$s = self, TMP_12.$$arity = 0, TMP_12));
          return extra_prepend.$call();}, TMP_11.$$s = self, TMP_11.$$arity = 0, TMP_11));
        if ((block !== nil)) {
          return Opal.yieldX(block, []);
          } else {
          return nil
        };}, TMP_10.$$s = self, TMP_10.$$arity = 0, TMP_10))
    }, TMP_Policy_generic_control_9.$$arity = -2);
    
    Opal.defn(self, '$render_text_control', TMP_Policy_render_text_control_15 = function $$render_text_control(variable, description) {
      var TMP_14, self = this;
    ...
    Opal.defn(self, '$render_boolean_control', TMP_Policy_render_boolean_control_24 = function $$render_boolean_control(variable, description) {
      var TMP_22, self = this;

      return self.$generic_control(description, $send(self, 'lambda', [], (TMP_22 = function(){var self = TMP_22.$$s || this, TMP_23;

      return $send(self.$div(), 'input_group_text', [], (TMP_23 = function(){var self = TMP_23.$$s || this;

        return self.$input($hash2(["type", "value", "onchange", "aria"], {"type": "checkbox", "value": self.$store().$value(variable), "onchange": self.$toggle(variable), "aria": $hash2(["label"], {"label": description})}))}, TMP_23.$$s = self, TMP_23.$$arity = 0, TMP_23))}, TMP_22.$$s = self, TMP_22.$$arity = 0, TMP_22)))
    }, TMP_Policy_render_boolean_control_24.$$arity = 2);
    
    Opal.defn(self, '$render_download_button', TMP_Policy_render_download_button_28 = function $$render_download_button() {
      var TMP_25, self = this, data_encoded = nil, uri = nil;
...
Opal.modules["components/home"] = function(Opal) {
  ...
  Opal.add_stubs(['$include', '$current_generator', '$store', '$===', '$component', '$text', '$class']);
  return (function($base, $super, $parent_nesting) {
    function $Home(){};
    var self = $Home = $klass($base, $super, 'Home', $Home);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Home_render_1;

    
    self.$include(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Inesita'), 'Component'));
    return (Opal.defn(self, '$render', TMP_Home_render_1 = function $$render() {
      var self = this, $case = nil;

      return (function() {$case = self.$store().$current_generator();
      if ("secret_control"['$===']($case)) {return self.$component(Opal.const_get_relative($nesting, 'SecretControlPolicy'))}
      else if ("secrets"['$===']($case)) {return self.$component(Opal.const_get_relative($nesting, 'SecretsPolicy'))}
      else if ("humans"['$===']($case)) {return self.$component(Opal.const_get_relative($nesting, 'HumansPolicy'))}
      else {return self.$text("" + "Error: can't show the policy (" + (self.$store().$current_generator()) + ", " + (self.$store().$current_generator().$class()) + ")")}})()
    }, TMP_Home_render_1.$$arity = 0), nil) && 'render';
  })($nesting[0], null, $nesting)
};
/* Generated by Opal 0.11.1 */
...
Opal.modules["components/navbar"] = function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.defn(self, '$change_generator_to', TMP_NavBar_change_generator_to_2 = function $$change_generator_to(new_generator) {
      var TMP_1, self = this;

      return $send(self, 'lambda', [], (TMP_1 = function(){var self = TMP_1.$$s || this;

      return self.$store().$change_generator(new_generator)}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1))
    }, TMP_NavBar_change_generator_to_2.$$arity = 1);
    
    Opal.defn(self, '$name_for', TMP_NavBar_name_for_3 = function $$name_for(generator) {
      var self = this;

      return self.$store().$supported_generators().$dig(generator, "name")
    }, TMP_NavBar_name_for_3.$$arity = 1);
    
    Opal.defn(self, '$render_policy_dropdown', TMP_NavBar_render_policy_dropdown_13 = function $$render_policy_dropdown() {
      var TMP_4, self = this;
...
if (name == null) name = nil;if (data == null) data = nil;
              return $send(self.$a(), 'dropdown_item', [$hash2(["href", "onclick"], {"href": "#", "onclick": self.$change_generator_to(name)})], (TMP_12 = function(){var self = TMP_12.$$s || this;
...
/* Generated by Opal 0.11.1 */
Opal.modules["lib/constants"] = function(Opal) {
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module;

  return (function($base, $parent_nesting) {
    var $Conjur, self = $Conjur = $module($base, 'Conjur');

    var def = self.$$proto, $nesting = [self].concat($parent_nesting);

    (function($base, $parent_nesting) {
      var $PolicyGenerator, self = $PolicyGenerator = $module($base, 'PolicyGenerator');

      var def = self.$$proto, $nesting = [self].concat($parent_nesting);

      
      Opal.const_set($nesting[0], 'HUMAN_NAMES', ["alice", "bob", "carol", "dan", "erin", "frank", "grace", "heidi", "judy", "mallory", "olivia", "peggy", "sibyl", "trent", "victor", "wendy"]);
      Opal.const_set($nesting[0], 'ANIMAL_NAMES', ["aardvark", "bobcat", "caribou", "dugong", "elephant", "fossa", "giraffe", "hedgehog", "impala", "jaguar", "koala", "lynx", "moose", "narwhal", "otter", "possum", "raccoon", "squirrel", "tapir", "walrus", "zebra"]);
      Opal.const_set($nesting[0], 'VARIABLE_NAMES', ["hydrogen", "lithium", "sodium", "potassium", "rubidium", "caesium", "francium"]);
      Opal.const_set($nesting[0], 'ANNOTATION_NAMES', ["density", "color", "conductivity", "malleability", "luster", "mass", "volume", "length"]);
      Opal.const_set($nesting[0], 'NATO_ALPHABET', ["alfa", "bravo", "charlie", "delta", "echo", "foxtrot", "golf", "hotel", "india", "juliett", "kilo", "lima", "mike", "november", "oscar", "papa", "quebec", "romeo", "sierra", "tango", "uniform", "victor", "whiskey", "x-ray", "yankee", "zulu"]);
    })($nesting[0], $nesting)
  })($nesting[0], $nesting)
};
/* Generated by Opal 0.11.1 */
...
/* Generated by Opal 0.11.1 */
Opal.modules["lib/generator"] = function(Opal) {
  function $rb_times(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs * rhs : lhs['$*'](rhs);
  }
  function $rb_plus(lhs, rhs) {
  ...
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $send = Opal.send, $truthy = Opal.truthy, $hash2 = Opal.hash2, $hash = Opal.hash, $klass = Opal.klass;

  Opal.add_stubs(['$extend', '$join', '$map!', '$split', '$*', '$require', '$uuid', '$indent', '$verticalList', '$chomp', '$each', '$empty?', '$lstrip', '$start_with?', '$+', '$!', '$map', '$verticalHash', '$nil?', '$renderAnnotations', '$renderBody', '$==', '$length', '$first', '$<=', '$inlineList', '$renderMembers', '$include', '$>', '$lambda', '$makeUnique', '$-', '$call', '$[]', '$%', '$slice', '$yaml', '$user', '$group', '$grant', '$flatten', '$to_sym', '$variable', '$blank_line', '$comment', '$policy', '$layer', '$host_factory', '$with_index', '$each_slice', '$taggedList', '$permit', '$render_hosts']);
  return (function($base, $parent_nesting) {
    var $Conjur, self = $Conjur = $module($base, 'Conjur');
    ...
    (function($base, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_PolicyGenerator_indent_2, TMP_PolicyGenerator_makeUnique_3, TMP_PolicyGenerator_taggedList_4, TMP_PolicyGenerator_verticalList_6, TMP_PolicyGenerator_verticalHash_8, TMP_PolicyGenerator_inlineList_9, TMP_PolicyGenerator_renderAnnotations_10, TMP_PolicyGenerator_comment_11, TMP_PolicyGenerator_blank_line_12, TMP_PolicyGenerator_yaml_13, TMP_PolicyGenerator_policy_15, TMP_PolicyGenerator_user_16, TMP_PolicyGenerator_group_17, TMP_PolicyGenerator_host_18, TMP_PolicyGenerator_layer_19, TMP_PolicyGenerator_host_factory_20, TMP_PolicyGenerator_grant_22, TMP_PolicyGenerator_permit_23, TMP_PolicyGenerator_variable_24;

      
      self.$extend(self);
      
      Opal.defn(self, '$indent', TMP_PolicyGenerator_indent_2 = function $$indent(text, number, char$) {
        var TMP_1, self = this;
        ...
        return $send(text.$split("\n"), 'map!', [], (TMP_1 = function(line){var self = TMP_1.$$s || this;
if (line == null) line = nil;
        return "" + ($rb_times(char$, number)) + (line)}, TMP_1.$$s = self, TMP_1.$$arity = 1, TMP_1)).$join("\n")
      }, TMP_PolicyGenerator_indent_2.$$arity = -2);
      self.$require("securerandom");
      
      Opal.defn(self, '$makeUnique', TMP_PolicyGenerator_makeUnique_3 = function $$makeUnique(string) {
        var self = this;

        return "" + (string) + "--" + (Opal.const_get_relative($nesting, 'SecureRandom').$uuid())
      }, TMP_PolicyGenerator_makeUnique_3.$$arity = 1);
      
      Opal.defn(self, '$taggedList', TMP_PolicyGenerator_taggedList_4 = function $$taggedList(tag, $a_rest) {
        var self = this, children, result = nil;
        ...
        result = "" + "&" + (tag) + "\n" + "" + (self.$indent($send(self, 'verticalList', Opal.to_a(children)))) + "\n";
        return result.$chomp();
      }, TMP_PolicyGenerator_taggedList_4.$$arity = -2);
      
      Opal.defn(self, '$verticalList', TMP_PolicyGenerator_verticalList_6 = function $$verticalList($a_rest) {
        var TMP_5, self = this, children, result = nil;

        var $args_len = arguments.length, $rest_len = $args_len - 0;
        if ($rest_len < 0) { $rest_len = 0; }
        children = new Array($rest_len);
        for (var $arg_idx = 0; $arg_idx < $args_len; $arg_idx++) {
          children[$arg_idx - 0] = arguments[$arg_idx];
        }
        
        result = "";
        $send(children, 'each', [], (TMP_5 = function(child){var self = TMP_5.$$s || this, $a, line_is_comment = nil;
if (child == null) child = nil;
        
          line_is_comment = ($truthy($a = child.$lstrip()['$empty?']()) ? $a : child.$lstrip()['$start_with?']("#"));
          return (result = $rb_plus(result, $rb_plus($rb_plus("" + ((function() {if ($truthy(line_is_comment['$!']())) {
            return "- "
            } else {
            return nil
          }; return nil; })()), child), "\n")));}, TMP_5.$$s = self, TMP_5.$$arity = 1, TMP_5));
        return result.$chomp();
      }, TMP_PolicyGenerator_verticalList_6.$$arity = -1);
      
      Opal.defn(self, '$verticalHash', TMP_PolicyGenerator_verticalHash_8 = function $$verticalHash($kwargs) {
        var TMP_7, self = this, pairs;
        ...
        pairs = Opal.kwrestargs($kwargs, {});
        return $send(pairs, 'map', [], (TMP_7 = function(key, val){var self = TMP_7.$$s || this;
if (key == null) key = nil;if (val == null) val = nil;
        return "" + (key) + ": " + (val)}, TMP_7.$$s = self, TMP_7.$$arity = 2, TMP_7)).$join("\n")
      }, TMP_PolicyGenerator_verticalHash_8.$$arity = -1);
      
      Opal.defn(self, '$inlineList', TMP_PolicyGenerator_inlineList_9 = function $$inlineList($a_rest) {
      ...
      }, TMP_PolicyGenerator_inlineList_9.$$arity = -1);
      
      Opal.defn(self, '$renderAnnotations', TMP_PolicyGenerator_renderAnnotations_10 = function $$renderAnnotations(hash) {
        var self = this;

        return "" + "annotations:\n" + "" + (self.$indent(self.$verticalHash(Opal.to_hash(hash)))) + "\n"
      }, TMP_PolicyGenerator_renderAnnotations_10.$$arity = 1);
      
      Opal.defn(self, '$comment', TMP_PolicyGenerator_comment_11 = function $$comment(text) {
        var self = this;

        if (text == null) {
          text = nil;
        }
        return "" + "#" + ((function() {if ($truthy(text['$nil?']()['$!']())) {
          return $rb_plus(" ", text)
          } else {
          return nil
        }; return nil; })())
      }, TMP_PolicyGenerator_comment_11.$$arity = -1);
      
      Opal.defn(self, '$blank_line', TMP_PolicyGenerator_blank_line_12 = function $$blank_line() {
        var self = this;

        return ""
      }, TMP_PolicyGenerator_blank_line_12.$$arity = 0);
      
      Opal.defn(self, '$yaml', TMP_PolicyGenerator_yaml_13 = function $$yaml($a_rest) {
        var self = this, children;
        ...
        return "" + "---\n" + "" + ($send(self, 'verticalList', Opal.to_a(children))) + "\n"
      }, TMP_PolicyGenerator_yaml_13.$$arity = -1);
      
      Opal.defn(self, '$policy', TMP_PolicyGenerator_policy_15 = function $$policy(name, $a_rest, $kwargs) {
        var $b, TMP_renderBody_14, self = this, $post_args, annotations, children, result = nil;
        ...
        annotations = Opal.kwrestargs($kwargs, {});
        if (0 < $post_args.length) {
          children = $post_args.splice(0, $post_args.length - 0);
        } else {
          children = [];
        }
        
        if ($truthy(($truthy($b = children['$empty?']()) ? annotations['$empty?']() : $b))) {
          return "" + "!policy " + (name)};
        
        Opal.def(self, '$renderBody', TMP_renderBody_14 = function $$renderBody(children) {
          var self = this;

          return "" + "body:\n" + "" + (self.$indent($send(self, 'verticalList', Opal.to_a(children)))) + "\n"
        }, TMP_renderBody_14.$$arity = 1);
        result = "" + "!policy\n" + "  id: " + (name) + "\n" + "" + ((function() {if ($truthy(annotations['$empty?']()['$!']())) {
          return self.$indent(self.$renderAnnotations(annotations))
          } else {
          return nil
        }; return nil; })()) + "\n";
        if ($truthy(annotations['$empty?']())) {
          result = result.$chomp()};
        if ($truthy(children['$empty?']()['$!']())) {
          result = $rb_plus(result, self.$indent(self.$renderBody(children)))};
        return result.$chomp();
      }, TMP_PolicyGenerator_policy_15.$$arity = -2);
      
      Opal.defn(self, '$user', TMP_PolicyGenerator_user_16 = function $$user(name) {
        var self = this;

        return "" + "!user " + (name)
      }, TMP_PolicyGenerator_user_16.$$arity = 1);
      
      Opal.defn(self, '$group', TMP_PolicyGenerator_group_17 = function $$group(name) {
        var self = this;

        return "" + "!group " + (name)
      }, TMP_PolicyGenerator_group_17.$$arity = 1);
      
      Opal.defn(self, '$host', TMP_PolicyGenerator_host_18 = function $$host(name) {
        var self = this;

        return "" + "!host " + (name)
      }, TMP_PolicyGenerator_host_18.$$arity = 1);
      
      Opal.defn(self, '$layer', TMP_PolicyGenerator_layer_19 = function $$layer(name) {
        var self = this;

        if (name == null) {
          name = nil;
        }
        return "" + "!layer" + ((function() {if ($truthy(name['$nil?']()['$!']())) {
          return $rb_plus(" ", name)
          } else {
          return nil
        }; return nil; })())
      }, TMP_PolicyGenerator_layer_19.$$arity = -1);
      
      Opal.defn(self, '$host_factory', TMP_PolicyGenerator_host_factory_20 = function $$host_factory(name) {
        var self = this;
      ...
      }, TMP_PolicyGenerator_host_factory_20.$$arity = -1);
      
      Opal.defn(self, '$grant', TMP_PolicyGenerator_grant_22 = function $$grant(role, $a_rest) {
        var TMP_renderMembers_21, self = this, members, result = nil;

        var $args_len = arguments.length, $rest_len = $args_len - 1;
        if ($rest_len < 0) { $rest_len = 0; }
        members = new Array($rest_len);
        for (var $arg_idx = 1; $arg_idx < $args_len; $arg_idx++) {
          members[$arg_idx - 1] = arguments[$arg_idx];
        }
        
        
        Opal.def(self, '$renderMembers', TMP_renderMembers_21 = function $$renderMembers(members) {
          var self = this;

          if (members.$length()['$=='](1)) {
            return "" + "member: " + (members.$first())
          } else if ($truthy($rb_le(members.$length(), 4))) {
            return "" + "members: " + ($send(self, 'inlineList', Opal.to_a(members)))
            } else {
            return "" + "members:\n" + (self.$indent($send(self, 'verticalList', Opal.to_a(members))))
          }
        }, TMP_renderMembers_21.$$arity = 1);
        result = "" + "!grant\n" + "  role: " + (role) + "\n" + "" + (self.$indent(self.$renderMembers(members))) + "\n";
        return result.$chomp();
      }, TMP_PolicyGenerator_grant_22.$$arity = -2);
      
      Opal.defn(self, '$permit', TMP_PolicyGenerator_permit_23 = function $$permit(role, privileges, resource, plural) {
        var self = this, result = nil;
        ...
        result = "" + "!permit\n" + "  role: " + (role) + "\n" + "  privileges: " + ($send(self, 'inlineList', Opal.to_a(privileges))) + "\n" + "  resource" + ((function() {if ($truthy(plural)) {
          return "s"
          } else {
          return nil
        }; return nil; })()) + ": " + (resource) + "\n";
        return result.$chomp();
      }, TMP_PolicyGenerator_permit_23.$$arity = -4);
      
      Opal.defn(self, '$variable', TMP_PolicyGenerator_variable_24 = function $$variable(name, $kwargs) {
        var self = this, annotations, result = nil;
        ...
        result = "" + "!variable\n" + "  id: " + (name) + "\n" + "" + (self.$indent(self.$renderAnnotations(annotations))) + "\n";
        return result.$chomp();
      }, TMP_PolicyGenerator_variable_24.$$arity = -2);
      (function($base, $super, $parent_nesting) {
        function $Humans(){};
        var self = $Humans = $klass($base, $super, 'Humans', $Humans);

        var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Humans_initialize_25, TMP_Humans_toMAML_34;

        def.users = def.groups = def.usersPerGroup = nil;
        
        self.$require("lib/generator"+ '/../' + "./constants");
        self.$include(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Conjur'), 'PolicyGenerator'));
        
        Opal.defn(self, '$initialize', TMP_Humans_initialize_25 = function $$initialize(users, groups, usersPerGroup) {
          var self = this;
          ...
          self.users = users;
          self.groups = groups;
          return (self.usersPerGroup = usersPerGroup);
        }, TMP_Humans_initialize_25.$$arity = -1);
        return (Opal.defn(self, '$toMAML', TMP_Humans_toMAML_34 = function $$toMAML() {
          var $a, TMP_26, TMP_27, TMP_28, TMP_29, TMP_30, TMP_31, TMP_32, self = this, numUserNames = nil, numGroupNames = nil, bigPolicy = nil, transform = nil, userStrings = nil, groupStrings = nil, grantObjects = nil;

          
          numUserNames = Opal.const_get_relative($nesting, 'HUMAN_NAMES').$length();
          numGroupNames = Opal.const_get_relative($nesting, 'ANIMAL_NAMES').$length();
          bigPolicy = ($truthy($a = $rb_gt(self.users, numUserNames)) ? $a : $rb_gt(self.groups, numGroupNames));
          transform = $send(self, 'lambda', [], (TMP_26 = function(string){var self = TMP_26.$$s || this;
if (string == null) string = nil;
          if ($truthy(bigPolicy)) {
          ...
          userStrings = $send(Opal.Range.$new(0, $rb_minus(self.users, 1), false), 'map', [], (TMP_27 = function(index){var self = TMP_27.$$s || this;
if (index == null) index = nil;
          return transform.$call(Opal.const_get_relative($nesting, 'HUMAN_NAMES')['$[]'](index['$%'](numUserNames)))}, TMP_27.$$s = self, TMP_27.$$arity = 1, TMP_27));
          groupStrings = $send(Opal.Range.$new(0, $rb_minus(self.groups, 1), false), 'map', [], (TMP_28 = function(index){var self = TMP_28.$$s || this;
if (index == null) index = nil;
          return transform.$call(Opal.const_get_relative($nesting, 'ANIMAL_NAMES')['$[]'](index['$%'](numGroupNames)))}, TMP_28.$$s = self, TMP_28.$$arity = 1, TMP_28));
          if ($truthy($rb_le(self.usersPerGroup, 0))) {
            } else {
            grantObjects = $send(groupStrings, 'map', [], (TMP_29 = function(group){var self = TMP_29.$$s || this;
              if (self.usersPerGroup == null) self.usersPerGroup = nil;
if (group == null) group = nil;
            return $hash2(["role", "members"], {"role": group, "members": userStrings.$slice(0, self.usersPerGroup)})}, TMP_29.$$s = self, TMP_29.$$arity = 1, TMP_29))
          };
          grantObjects = ($truthy($a = grantObjects) ? $a : []);
          return $send(self, 'yaml', Opal.to_a($send(userStrings, 'map', [], (TMP_30 = function(name){var self = TMP_30.$$s || this;
if (name == null) name = nil;
          return self.$user(name)}, TMP_30.$$s = self, TMP_30.$$arity = 1, TMP_30))).concat(Opal.to_a($send(groupStrings, 'map', [], (TMP_31 = function(name){var self = TMP_31.$$s || this;
if (name == null) name = nil;
          return self.$group(name)}, TMP_31.$$s = self, TMP_31.$$arity = 1, TMP_31)))).concat(Opal.to_a($send(grantObjects, 'map', [], (TMP_32 = function(data){var self = TMP_32.$$s || this, TMP_33;
if (data == null) data = nil;
          return $send(self, 'grant', [self.$group(data['$[]']("role"))].concat(Opal.to_a($send(data['$[]']("members"), 'map', [], (TMP_33 = function(name){var self = TMP_33.$$s || this;
if (name == null) name = nil;
            return self.$user(name)}, TMP_33.$$s = self, TMP_33.$$arity = 1, TMP_33)))))}, TMP_32.$$s = self, TMP_32.$$arity = 1, TMP_32)))));
        }, TMP_Humans_toMAML_34.$$arity = 0), nil) && 'toMAML';
      })($nesting[0], null, $nesting);
      (function($base, $super, $parent_nesting) {
        function $Secrets(){};
        var self = $Secrets = $klass($base, $super, 'Secrets', $Secrets);

        var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Secrets_initialize_35, TMP_Secrets_toMAML_40;

        def.secrets = def.annotationsPerSecret = nil;
        
        self.$require("lib/generator"+ '/../' + "./constants");
        self.$include(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Conjur'), 'PolicyGenerator'));
        
        Opal.defn(self, '$initialize', TMP_Secrets_initialize_35 = function $$initialize(secrets, annotationsPerSecret) {
          var self = this;

          if (secrets == null) {
            secrets = 1;
          }
          if (annotationsPerSecret == null) {
            annotationsPerSecret = 0;
          }
          
          self.secrets = secrets;
          return (self.annotationsPerSecret = annotationsPerSecret);
        }, TMP_Secrets_initialize_35.$$arity = -1);
        return (Opal.defn(self, '$toMAML', TMP_Secrets_toMAML_40 = function $$toMAML() {
          var $a, TMP_36, TMP_37, TMP_38, TMP_39, self = this, numSecretNames = nil, numAnnotationNames = nil, bigPolicy = nil, transform = nil, secretStrings = nil, annotationHash = nil;

          
          numSecretNames = Opal.const_get_relative($nesting, 'VARIABLE_NAMES').$length();
          numAnnotationNames = Opal.const_get_relative($nesting, 'ANNOTATION_NAMES').$length();
          bigPolicy = ($truthy($a = $rb_gt(self.secrets, numSecretNames)) ? $a : $rb_gt(self.annotationsPerSecret, numAnnotationNames));
          transform = $send(self, 'lambda', [], (TMP_36 = function(string){var self = TMP_36.$$s || this;
if (string == null) string = nil;
          if ($truthy(bigPolicy)) {
              return self.$makeUnique(string)
              } else {
          ...
          secretStrings = $send(Opal.Range.$new(0, $rb_minus(self.secrets, 1), false), 'map', [], (TMP_37 = function(index){var self = TMP_37.$$s || this;
if (index == null) index = nil;
          return transform.$call(Opal.const_get_relative($nesting, 'VARIABLE_NAMES')['$[]'](index['$%'](numSecretNames)))}, TMP_37.$$s = self, TMP_37.$$arity = 1, TMP_37));
          annotationHash = $send(Opal.const_get_relative($nesting, 'Hash'), '[]', Opal.to_a($send(Opal.Range.$new(0, $rb_minus(self.annotationsPerSecret, 1), false), 'map', [], (TMP_38 = function(index){var self = TMP_38.$$s || this;
if (index == null) index = nil;
          return [transform.$call(Opal.const_get_relative($nesting, 'ANNOTATION_NAMES')['$[]'](index['$%'](numAnnotationNames))).$to_sym(), "value"]}, TMP_38.$$s = self, TMP_38.$$arity = 1, TMP_38)).$flatten()));
          return $send(self, 'yaml', Opal.to_a($send(secretStrings, 'map', [], (TMP_39 = function(name){var self = TMP_39.$$s || this;
if (name == null) name = nil;
          return self.$variable(name, Opal.to_hash(annotationHash))}, TMP_39.$$s = self, TMP_39.$$arity = 1, TMP_39))));
        }, TMP_Secrets_toMAML_40.$$arity = 0), nil) && 'toMAML';
      })($nesting[0], null, $nesting);
      (function($base, $parent_nesting) {
        var $Template, self = $Template = $module($base, 'Template');

        var def = self.$$proto, $nesting = [self].concat($parent_nesting);

        (function($base, $super, $parent_nesting) {
          function $SecretControl(){};
          var self = $SecretControl = $klass($base, $super, 'SecretControl', $SecretControl);

          var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_SecretControl_initialize_41, TMP_SecretControl_toMAML_49;

          def.secrets_per_group = def.secret_groups = def.application_name = def.include_hostfactory = nil;
          
          self.$require("lib/generator"+ '/../' + "./constants");
          self.$include(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Conjur'), 'PolicyGenerator'));
          
          Opal.defn(self, '$initialize', TMP_SecretControl_initialize_41 = function $$initialize(application_name, secret_groups, secrets_per_group, include_hostfactory) {
            var self = this;

            if (application_name == null) {
              application_name = "example";
            }
            if (secret_groups == null) {
              secret_groups = 2;
            }
            if (secrets_per_group == null) {
              secrets_per_group = 2;
            }
            if (include_hostfactory == null) {
              include_hostfactory = false;
            }
            
            self.application_name = application_name;
            self.secret_groups = secret_groups;
            self.secrets_per_group = secrets_per_group;
            return (self.include_hostfactory = include_hostfactory);
          }, TMP_SecretControl_initialize_41.$$arity = -1);
          return (Opal.defn(self, '$toMAML', TMP_SecretControl_toMAML_49 = function $$toMAML() {
            var $a, TMP_42, TMP_43, TMP_44, TMP_render_hosts_46, TMP_47, self = this, numSecretNames = nil, numGroupNames = nil, bigPolicy = nil, transform = nil, secretStrings = nil, groupStrings = nil;

            
            numSecretNames = Opal.const_get_relative($nesting, 'VARIABLE_NAMES').$length();
            numGroupNames = Opal.const_get_relative($nesting, 'NATO_ALPHABET').$length();
            bigPolicy = ($truthy($a = $rb_gt($rb_times(self.secrets_per_group, self.secret_groups), numSecretNames)) ? $a : $rb_gt(self.secret_groups, numGroupNames));
            transform = $send(self, 'lambda', [], (TMP_42 = function(string){var self = TMP_42.$$s || this;
if (string == null) string = nil;
            if ($truthy(bigPolicy)) {
                return self.$makeUnique(string)
                } else {
                return string
              }}, TMP_42.$$s = self, TMP_42.$$arity = 1, TMP_42));
            secretStrings = $send(Opal.Range.$new(0, $rb_minus($rb_times(self.secrets_per_group, self.secret_groups), 1), false), 'map', [], (TMP_43 = function(index){var self = TMP_43.$$s || this;
if (index == null) index = nil;
            return transform.$call(Opal.const_get_relative($nesting, 'VARIABLE_NAMES')['$[]'](index['$%'](numSecretNames)))}, TMP_43.$$s = self, TMP_43.$$arity = 1, TMP_43));
            groupStrings = $send(Opal.Range.$new(0, $rb_minus(self.secret_groups, 1), false), 'map', [], (TMP_44 = function(index){var self = TMP_44.$$s || this;
if (index == null) index = nil;
            return transform.$call(Opal.const_get_relative($nesting, 'NATO_ALPHABET')['$[]'](index['$%'](numGroupNames)))}, TMP_44.$$s = self, TMP_44.$$arity = 1, TMP_44));
            
            Opal.def(self, '$render_hosts', TMP_render_hosts_46 = function $$render_hosts(groups) {
              var TMP_45, self = this;

              return [self.$blank_line(), self.$comment("=== Layer for Automated Secret Access ==="), self.$policy("hosts", self.$layer(), self.$host_factory(), $hash2(["description"], {"description": "Layer & Host Factory for machines that can read secrets"})), $send(groups, 'map', [], (TMP_45 = function(group){var self = TMP_45.$$s || this;
if (group == null) group = nil;
              return self.$grant(self.$group("" + (group) + "/secrets-users"), self.$layer("hosts"))}, TMP_45.$$s = self, TMP_45.$$arity = 1, TMP_45))].$flatten()
            }, TMP_render_hosts_46.$$arity = 1);
            return self.$yaml($send(self, 'policy', [self.application_name].concat(Opal.to_a($send(secretStrings.$each_slice(self.secrets_per_group).$with_index(), 'map', [], (TMP_47 = function(secrets, group_index){var self = TMP_47.$$s || this, TMP_48;
if (secrets == null) secrets = nil;if (group_index == null) group_index = nil;
            return self.$policy(groupStrings['$[]'](group_index), self.$comment("Secret Declarations"), $send(self, 'taggedList', ["secrets"].concat(Opal.to_a($send(secrets, 'map', [], (TMP_48 = function(name){var self = TMP_48.$$s || this;
if (name == null) name = nil;
              return self.$variable(name)}, TMP_48.$$s = self, TMP_48.$$arity = 1, TMP_48))))), self.$blank_line(), self.$comment("User & Manager Groups"), self.$group("secrets-users"), self.$group("secrets-managers"), self.$permit(self.$group("secrets-users"), ["read", "execute"], "*secrets", $hash2(["plural"], {"plural": true})), self.$permit(self.$group("secrets-managers"), ["read", "execute", "update"], "*secrets", $hash2(["plural"], {"plural": true})))}, TMP_47.$$s = self, TMP_47.$$arity = 2, TMP_47)))).concat(Opal.to_a((function() {if ($truthy(self.include_hostfactory)) {
              return self.$render_hosts(groupStrings)
              } else {
              return nil
            }; return nil; })()))));
          }, TMP_SecretControl_toMAML_49.$$arity = 0), nil) && 'toMAML';
        })($nesting[0], null, $nesting)
      })($nesting[0], $nesting);
    })($nesting[0], $nesting)
  })($nesting[0], $nesting)
