...
Opal.modules["router"] = function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Router_routes_1;

    
    self.$include(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Inesita'), 'Router'));
    return (Opal.defn(self, '$routes', TMP_Router_routes_1 = function $$routes() {
      var self = this;

      
      self.$route("/", $hash2(["to"], {"to": Opal.const_get_relative($nesting, 'Home')}));
      return self.$route("/about", $hash2(["to"], {"to": Opal.const_get_relative($nesting, 'About')}));
    }, TMP_Router_routes_1.$$arity = 0), nil) && 'routes';
  })($nesting[0], null, $nesting)
};
/* Generated by Opal 0.11.1 */
